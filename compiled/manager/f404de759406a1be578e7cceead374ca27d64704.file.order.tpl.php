<?php /* Smarty version Smarty-3.1.18, created on 2022-06-29 19:15:49
         compiled from "/home/e/ecofinance/rubl_crm/public_html/theme/manager/html/order.tpl" */ ?>
<?php /*%%SmartyHeaderCode:13490034262bc7ab5155d57-79853032%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f404de759406a1be578e7cceead374ca27d64704' => 
    array (
      0 => '/home/e/ecofinance/rubl_crm/public_html/theme/manager/html/order.tpl',
      1 => 1656438503,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '13490034262bc7ab5155d57-79853032',
  'function' => 
  array (
    'penalty_button' => 
    array (
  ...
  'unifunc' => 'content_62bc7ab5373d23_65666484',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_62bc7ab5373d23_65666484')) {function content_62bc7ab5373d23_65666484($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/home/e/ecofinance/rubl_crm/public_html/Smarty/libs/plugins/modifier.date_format.php';
...
/js/apps/order.js?v=1.27"></script>
    <script type="text/javascript" src="theme/<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['settings']->value->theme, ENT_QUOTES, 'UTF-8', true);?>
...
<?php if (!function_exists('smarty_template_function_penalty_button')) {
    ...
    <?php if (in_array('add_penalty',$_smarty_tpl->tpl_vars['manager']->value->permissions)) {?>
        ...
        <button type="button" class="pb-0 pt-0 mr-2 btn btn-sm btn-danger waves-effect js-add-penalty " data-block="<?php echo $_smarty_tpl->tpl_vars['penalty_block']->value;?>
">
        ...
        <button type="button" class="pb-0 pt-0 mr-2 btn btn-sm btn-primary waves-effect js-reject-penalty " data-penalty="<?php echo $_smarty_tpl->tpl_vars['penalties']->value[$_smarty_tpl->tpl_vars['penalty_block']->value]->id;?>
">
            <i class="fas fa-ban"></i>
            <span>Отменить</span>
        </button>
        <button type="button" class="pb-0 pt-0 mr-2 btn btn-sm btn-warning waves-effect js-strike-penalty " data-penalty="<?php echo $_smarty_tpl->tpl_vars['penalties']->value[$_smarty_tpl->tpl_vars['penalty_block']->value]->id;?>
">
            <i class="fas fa-ban"></i>
            <span>Страйк</span>
        </button>
 ...
 руб)</span>
    ...
    <?php } elseif ($_smarty_tpl->tpl_vars['penalties']->value[$_smarty_tpl->tpl_vars['penalty_block']->value]->manager_id==$_smarty_tpl->tpl_vars['manager']->value->id) {?>
        ...
        <button class="pb-0 pt-0 mr-2 btn btn-sm btn-primary js-correct-penalty" data-penalty="<?php echo $_smarty_tpl->tpl_vars['penalties']->value[$_smarty_tpl->tpl_vars['penalty_block']->value]->id;?>
" type="button">Исправить</button>
        <?php }?>
        <?php if (in_array($_smarty_tpl->tpl_vars['penalties']->value[$_smarty_tpl->tpl_vars['penalty_block']->value]->status,array(4))) {?>
        <span class="label label-warning">Страйк (<?php echo $_smarty_tpl->tpl_vars['penalties']->value[$_smarty_tpl->tpl_vars['penalty_block']->value]->cost;?>
 руб)</span>
...
" title="Перейти в карточку клиента">
 ...
 <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['time'][0][0]->time_modifier($_smarty_tpl->tpl_vars['order']->value->date);?>
                ...
                <div style="text-align: center; width: 30%; margin-left: 200px; background-color: rgba(255,0,0,0.6); border-radius: 6px;">
                    <h5 style="text-align: center; color: white; margin:50px">Право требования задолженности по договору уступлено в ООО "Юридическая компания № 1"
        ...
        <div class="row page-titles">
            ...
            <div class="col-md-6 col-4 align-self-center">
                <h1 class="text-right p-1" id="ordertimer">
                    ...
                    <div class="text-primary js-ordertimer text-center float-right" style="width:150px" data-time="<?php echo $_smarty_tpl->tpl_vars['ordertimer']->value->last_time;?>
"></div>
                    <?php }?>
                </h1>
            </div>
                                    ...
                                    <div class="col-4 col-md-3 col-lg-2">
                                        <h4 class="form-control-static">
                                            <?php if ($_smarty_tpl->tpl_vars['order']->value->client_status) {?>
                                                <?php if ($_smarty_tpl->tpl_vars['order']->value->client_status=='pk') {?><span class="label label-success" title="Клиент уже имеет погашенные займы">ПК</span>
                                                <?php } elseif ($_smarty_tpl->tpl_vars['order']->value->client_status=='crm') {?><span class="label label-primary" title="Клиент уже имеет погашенные займы в CRM">ПК CRM</span>
                                                <?php } elseif ($_smarty_tpl->tpl_vars['order']->value->client_status=='rep') {?><span class="label label-warning" title="Клиент уже подавал ранее заявки">Повтор</span>
                                                <?php } elseif ($_smarty_tpl->tpl_vars['order']->value->client_status=='nk') {?><span class="label label-info" title="Новый клиент">Новая</span>
                                                <?php }?>
                                            <?php } else { ?>
...
" target="_blank" class="btn btn-info float-right"><i class=" fas fa-address-book"></i> Смотреть ЛК</a>
                                        <?php }?>
                                    </div>
                                    <div class="col-12 col-md-6 col-lg-3 ">
                                        <h5 class="js-order-manager text-right">
                                            <?php if (in_array($_smarty_tpl->tpl_vars['manager']->value->role,array('developer','admin','big_user'))) {?>
                                                <select class="js-order-manager form-control" data-order="<?php echo $_smarty_tpl->tpl_vars['order']->value->order_id;?>
" name="manager_id">
                                                    <option value="0" <?php if (!$_smarty_tpl->tpl_vars['order']->value->manager_id) {?>selected="selected"<?php }?>>Не принята</option>
...
" title="Перейти в карточку клиента">
                                                ...
                                                <h3>
                                                    ...
                                                    <button class="js-mango-call mango-call js-event-add-click" data-phone="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order']->value->phone_mobile, ENT_QUOTES, 'UTF-8', true);?>
" title="Выполнить звонок" data-event="60" data-manager="<?php echo $_smarty_tpl->tpl_vars['manager']->value->id;?>
" data-order="<?php echo $_smarty_tpl->tpl_vars['order']->value->order_id;?>
" data-user="<?php echo $_smarty_tpl->tpl_vars['order']->value->user_id;?>
">
                                                        <i class="fas fa-mobile-alt"></i>
                                                    </button>                                                
                                                    <button class="js-open-sms-modal mango-call <?php if ($_smarty_tpl->tpl_vars['order']->value->contract->sold) {?>js-yuk<?php }?>" data-user="<?php echo $_smarty_tpl->tpl_vars['order']->value->user_id;?>
" data-order="<?php echo $_smarty_tpl->tpl_vars['order']->value->order_id;?>
">
                                                        <i class=" far fa-share-square"></i>
                                                    </button>
                                                </h3>
                                                <a href="javascript:void(0);" class="text-info js-edit-form edit-amount js-event-add-click" data-event="30" data-manager="<?php echo $_smarty_tpl->tpl_vars['manager']->value->id;?>
" data-order="<?php echo $_smarty_tpl->tpl_vars['order']->value->order_id;?>
" data-user="<?php echo $_smarty_tpl->tpl_vars['order']->value->user_id;?>
...
" class="form-control" placeholder="Фамилия" />
                                                ...
                                                <div class="form-group mb-1">
                                                    <input type="text" name="firstname" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order']->value->firstname, ENT_QUOTES, 'UTF-8', true);?>
" class="form-control" placeholder="Имя" />
                                                </div>
                                                <div class="form-group mb-1">
                                                    <input type="text" name="patronymic" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order']->value->patronymic, ENT_QUOTES, 'UTF-8', true);?>
" class="form-control" placeholder="Отчество" />
                                                </div>
                                                <div class="form-group mb-1">
                                                    <input type="text" name="phone_mobile" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order']->value->phone_mobile, ENT_QUOTES, 'UTF-8', true);?>
" class="form-control" placeholder="Телефон" />
                                                </div>
                                                <div class="form-actions">
                                                    <button type="submit" class="btn btn-success js-event-add-click" data-event="40" data-manager="<?php echo $_smarty_tpl->tpl_vars['manager']->value->id;?>
" data-order="<?php echo $_smarty_tpl->tpl_vars['order']->value->order_id;?>
" data-user="<?php echo $_smarty_tpl->tpl_vars['order']->value->user_id;?>
"> <i class="fa fa-check"></i> Сохранить</button>
                                    ...
                                    <div class="col-12 col-md-8 col-lg-6">
                                        <form action="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0][0]->url_modifier(array(),$_smarty_tpl);?>
" class="mb-3 p-2 border js-order-item-form js-check-amount" id="amount_form">
...
?>
 ...
 <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['plural'][0][0]->plural_modifier($_smarty_tpl->tpl_vars['order']->value->period,"день","дней","дня");?>
                                                ...
                                                <div class="col-12 text-center">
                                                    <h4 class="text-danger">Максимальная сумма: <?php echo $_smarty_tpl->tpl_vars['order']->value->antirazgon_amount;?>
 руб</h4>
                                                </div>
                                                <?php }?>
                                                <?php if ($_smarty_tpl->tpl_vars['order']->value->status<=2||in_array($_smarty_tpl->tpl_vars['manager']->value->role,array('admin','developer'))) {?>
                                                <a href="javascript:void(0);" class="text-info js-edit-form edit-amount js-event-add-click" data-event="31" data-manager="<?php echo $_smarty_tpl->tpl_vars['manager']->value->id;?>
" data-order="<?php echo $_smarty_tpl->tpl_vars['order']->value->order_id;?>
" data-user="<?php echo $_smarty_tpl->tpl_vars['order']->value->user_id;?>
"><i class=" fas fa-edit"></i></a></h3>
                                                <?php }?>
                                            </div>
                                            ...
                                            <div class="row edit-block hide">
                                                <div class="col-6 col-md-3 text-center">
                                                    <h5>Сумма</h5>
                                                    <input type="text" class="form-control" name="amount" value="<?php echo $_smarty_tpl->tpl_vars['order']->value->amount;?>
" />
                                                </div>
                                                <div class="col-6 col-md-3 text-center">
                                                    <h5>Период</h5>
                                                    <input type="text" class="form-control" name="period" value="<?php echo $_smarty_tpl->tpl_vars['order']->value->period;?>
" />
                                                </div>
                                                <div class="col-12 col-md-6">
                                                    <div class="form-actions">
                                                        <h5>&nbsp;</h5>
                                                        <button type="submit" class="btn btn-success js-event-add-click" data-event="41" data-manager="<?php echo $_smarty_tpl->tpl_vars['manager']->value->id;?>
" data-order="<?php echo $_smarty_tpl->tpl_vars['order']->value->order_id;?>
" data-user="<?php echo $_smarty_tpl->tpl_vars['order']->value->user_id;?>
"> <i class="fa fa-check"></i> Сохранить</button>
                                                        <button type="button" class="btn btn-inverse js-cancel-edit">Отмена</button>
                                    ...
                                    <div class="col-12 col-md-6 col-lg-3">
                                        ...
                                        <div class="pt-3 js-accept-order-block">
                                            <button class="btn btn-info btn-lg btn-block js-accept-order js-event-add-click" data-event="10" data-manager="<?php echo $_smarty_tpl->tpl_vars['manager']->value->id;?>
" data-order="<?php echo $_smarty_tpl->tpl_vars['order']->value->order_id;?>
" data-user="<?php echo $_smarty_tpl->tpl_vars['order']->value->user_id;?>
" >
                                        ...
                                        <div class="pt-1 pb-2 js-accept-order-block">
                                            <button class="btn btn-info btn-block js-accept-order js-event-add-click" data-event="11" data-user="<?php echo $_smarty_tpl->tpl_vars['order']->value->user_id;?>
" data-order="<?php echo $_smarty_tpl->tpl_vars['order']->value->order_id;?>
...
">
                                        ...
                                        <div class="js-approve-reject-block <?php if (!$_smarty_tpl->tpl_vars['order']->value->manager_id) {?>hide<?php }?>">
                                            <button class="btn btn-success btn-block js-approve-order js-event-add-click" data-event="12" data-user="<?php echo $_smarty_tpl->tpl_vars['order']->value->user_id;?>
" data-order="<?php echo $_smarty_tpl->tpl_vars['order']->value->order_id;?>
" data-manager="<?php echo $_smarty_tpl->tpl_vars['manager']->value->id;?>
">
                                            ...
                                            <button class="btn btn-danger btn-block js-reject-order js-event-add-click" data-event="13" data-user="<?php echo $_smarty_tpl->tpl_vars['order']->value->user_id;?>
" data-order="<?php echo $_smarty_tpl->tpl_vars['order']->value->order_id;?>
" data-manager="<?php echo $_smarty_tpl->tpl_vars['manager']->value->id;?>
">
...
">
                                            ...
                                            <form class=" pt-1 js-confirm-contract">
                                                <div class="input-group">
                                                    <input type="hidden" name="contract_id" class="js-contract-id" value="<?php echo $_smarty_tpl->tpl_vars['order']->value->contract_id;?>
" />
                                                    <input type="hidden" name="phone" class="js-contract-phone" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order']->value->phone_mobile, ENT_QUOTES, 'UTF-8', true);?>
" />
                                                    <input type="text" class="form-control js-contract-code" placeholder="SMS код" value="<?php if ($_smarty_tpl->tpl_vars['is_developer']->value) {?><?php echo $_smarty_tpl->tpl_vars['contract']->value->accept_code;?>
<?php }?>" />
                                                    <div class="input-group-append">
                                                        <button class="btn btn-info js-event-add-click" type="submit" data-event="14" data-user="<?php echo $_smarty_tpl->tpl_vars['order']->value->user_id;?>
" data-order="<?php echo $_smarty_tpl->tpl_vars['order']->value->order_id;?>
" data-manager="<?php echo $_smarty_tpl->tpl_vars['manager']->value->id;?>
">Подтвердить</button>
                                                    </div>
                                                </div>
                                                    <a href="javascript:void(0);" class="js-sms-send" data-contract="<?php echo $_smarty_tpl->tpl_vars['order']->value->contract_id;?>
">
                                            ...
                                            <div class="card card-danger">
                                                <div class="box text-center">
                                                    ...
                                                    <small title="Причина отказа"><i><?php echo $_smarty_tpl->tpl_vars['reject_reasons']->value[$_smarty_tpl->tpl_vars['order']->value->reason_id]->admin_name;?>
</i></small>
                                                    <?php if ($_smarty_tpl->tpl_vars['order']->value->antirazgon_date) {?>
                                                    <br />
                                                    <strong class="text-white"><small>Мараторий до <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['date'][0][0]->date_modifier($_smarty_tpl->tpl_vars['order']->value->antirazgon_date);?>
</small></strong>
                                                    <?php }?>
                                                </div>
                                            </div>
...
">
 ...
 руб
                                                ...
                                                <button class="btn btn-danger btn-block js-open-close-form js-event-add-click" data-event="15" data-user="<?php echo $_smarty_tpl->tpl_vars['order']->value->user_id;?>
" data-order="<?php echo $_smarty_tpl->tpl_vars['order']->value->order_id;?>
" data-manager="<?php echo $_smarty_tpl->tpl_vars['manager']->value->id;?>
">Закрыть договор</button>
                                                <?php }?>
                                                <?php if ($_smarty_tpl->tpl_vars['is_developer']->value) {?>
                                                <button class="btn btn-info btn-block js-open-correct-form " data-event="15" data-user="<?php echo $_smarty_tpl->tpl_vars['order']->value->user_id;?>
" data-order="<?php echo $_smarty_tpl->tpl_vars['order']->value->order_id;?>
" data-manager="<?php echo $_smarty_tpl->tpl_vars['manager']->value->id;?>
                                                ...
                                                <div class="card card-danger mb-1">
                                                    <div class="box text-center">
                                                        ...
                                                        <?php if ($_smarty_tpl->tpl_vars['p2p']->value->response_xml) {?>
                                                            <i><small>B2P: <?php echo $_smarty_tpl->tpl_vars['p2p']->value->response_xml->message;?>
</small></i>
                                                        <?php } else { ?> 
...
"><strong class="text-danger text-center">У клиента есть новая заявка</strong></a>
                                                </div>
                                                <?php } else { ?>
                                                    <?php if (in_array('repay_button',$_smarty_tpl->tpl_vars['manager']->value->permissions)) {?>
                                                    <button type="button" class="btn btn-primary btn-block js-repay-contract js-event-add-click" data-event="16" data-user="<?php echo $_smarty_tpl->tpl_vars['order']->value->user_id;?>
" data-order="<?php echo $_smarty_tpl->tpl_vars['order']->value->order_id;?>
" data-manager="<?php echo $_smarty_tpl->tpl_vars['manager']->value->id;?>
" data-contract="<?php echo $_smarty_tpl->tpl_vars['contract']->value->id;?>
">Повторить выдачу</button>
                                                    <?php }?>
                                                <?php }?>
                                            <?php }?>
                                            ...
                                            <div class="card border border-danger">
                                                <div class="box text-center">
                                                    ...
                                                    <button class="btn btn-outline-warning js-cancel-contract" data-contract="<?php echo $_smarty_tpl->tpl_vars['contract']->value->id;?>
" type="button">Отменить заявку</button>
                                                </div>
                                            </div>
                                            <?php }?>
                            ...
                            <ul class="mt-2 nav nav-tabs" role="tablist" id="order_tabs">
                                <li class="nav-item"> 
                                    <a class="nav-link active js-event-add-click" data-toggle="tab" href="#info" role="tab" aria-selected="false" data-event="20" data-user="<?php echo $_smarty_tpl->tpl_vars['order']->value->user_id;?>
" data-order="<?php echo $_smarty_tpl->tpl_vars['order']->value->order_id;?>
" data-manager="<?php echo $_smarty_tpl->tpl_vars['manager']->value->id;?>
" >
                                ...
                                <li class="nav-item"> 
                                    <a class="nav-link js-event-add-click" data-toggle="tab" href="#comments" role="tab" aria-selected="false" data-event="21" data-user="<?php echo $_smarty_tpl->tpl_vars['order']->value->user_id;?>
" data-order="<?php echo $_smarty_tpl->tpl_vars['order']->value->order_id;?>
" data-manager="<?php echo $_smarty_tpl->tpl_vars['manager']->value->id;?>
" >
                                ...
                                <li class="nav-item"> 
                                    <a class="nav-link js-event-add-click" data-toggle="tab" href="#documents" role="tab" aria-selected="true" data-event="22" data-user="<?php echo $_smarty_tpl->tpl_vars['order']->value->user_id;?>
" data-order="<?php echo $_smarty_tpl->tpl_vars['order']->value->order_id;?>
" data-manager="<?php echo $_smarty_tpl->tpl_vars['manager']->value->id;?>
" >
                                ...
                                <li class="nav-item"> 
                                    <a class="nav-link js-event-add-click" data-toggle="tab" href="#logs" role="tab" aria-selected="true" data-event="23" data-user="<?php echo $_smarty_tpl->tpl_vars['order']->value->user_id;?>
" data-order="<?php echo $_smarty_tpl->tpl_vars['order']->value->order_id;?>
" data-manager="<?php echo $_smarty_tpl->tpl_vars['manager']->value->id;?>
" >
                                ...
                                <li class="nav-item"> 
                                    <a class="nav-link js-event-add-click" data-toggle="tab" href="#operations" role="tab" aria-selected="true" data-event="24" data-user="<?php echo $_smarty_tpl->tpl_vars['order']->value->user_id;?>
" data-order="<?php echo $_smarty_tpl->tpl_vars['order']->value->order_id;?>
" data-manager="<?php echo $_smarty_tpl->tpl_vars['manager']->value->id;?>
" >
                                ...
                                <li class="nav-item"> 
                                    <a class="nav-link js-event-add-click" data-toggle="tab" href="#history" role="tab" aria-selected="true" data-event="25" data-user="<?php echo $_smarty_tpl->tpl_vars['order']->value->user_id;?>
" data-order="<?php echo $_smarty_tpl->tpl_vars['order']->value->order_id;?>
" data-manager="<?php echo $_smarty_tpl->tpl_vars['manager']->value->id;?>
" >
                                ...
                                <li class="nav-item js-event-add-click">
                                    <a class="nav-link" data-toggle="tab" href="#connexions" role="tab" aria-selected="true" data-event="25" data-user="<?php echo $_smarty_tpl->tpl_vars['order']->value->user_id;?>
" data-order="<?php echo $_smarty_tpl->tpl_vars['order']->value->order_id;?>
" data-manager="<?php echo $_smarty_tpl->tpl_vars['manager']->value->id;?>
" >
                                ...
                                <li class="nav-item"> 
                                    <a class="nav-link js-event-add-click" data-toggle="tab" href="#communications" role="tab" aria-selected="true" data-event="25" data-user="<?php echo $_smarty_tpl->tpl_vars['order']->value->user_id;?>
" data-order="<?php echo $_smarty_tpl->tpl_vars['order']->value->order_id;?>
" data-manager="<?php echo $_smarty_tpl->tpl_vars['manager']->value->id;?>
" >
                                    ...
                                    <div class="form-body p-2 pt-3">
                                        ...
                                        <div class="row">
                                            <div class="col-md-8 ">
                                                ...
                                                <!-- Контакты -->
                                                <form action="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0][0]->url_modifier(array(),$_smarty_tpl);?>
" class="mb-3 border js-order-item-form <?php if ($_smarty_tpl->tpl_vars['penalties']->value['personal']&&$_smarty_tpl->tpl_vars['penalties']->value['personal']->status!=3) {?>card-outline-danger<?php }?>" id="personal_data_form">
...
" />
                                                    ...
                                                    <h5 class="card-header card-success">
                                                        ...
                                                        <span class="float-right"> 
                                                            ...
                                                            <a href="javascript:void(0);" class=" text-white js-edit-form js-event-add-click" data-event="32" data-manager="<?php echo $_smarty_tpl->tpl_vars['manager']->value->id;?>
" data-order="<?php echo $_smarty_tpl->tpl_vars['order']->value->order_id;?>
" data-user="<?php echo $_smarty_tpl->tpl_vars['order']->value->user_id;?>
"><i class=" fas fa-edit"></i></a></h3>
                                                        </span>
                                                            ...
                                                            <div class="form-group row m-0">
                                                                ...
                                                                <div class="col-md-8">
                                                                    <ul class="list-unstyled form-control-static pl-0">
                                                                        ...
                                                                        <li>
                                                                            <a target="_blank" href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order']->value->social, ENT_QUOTES, 'UTF-8', true);?>
                                                    ...
                                                    <div class="row p-2 edit-block <?php if (!$_smarty_tpl->tpl_vars['contactdata_error']->value) {?>hide<?php }?>">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group mb-1 <?php if (in_array('empty_email',(array)$_smarty_tpl->tpl_vars['contactdata_error']->value)) {?>has-danger<?php }?>">
                                                                ...
                                                                <input type="text" name="email" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order']->value->email, ENT_QUOTES, 'UTF-8', true);?>
" class="form-control" placeholder="" />
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group mb-1 <?php if (in_array('empty_birth',(array)$_smarty_tpl->tpl_vars['contactdata_error']->value)) {?>has-danger<?php }?>">
                                                                ...
                                                                <input type="text" name="birth" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order']->value->birth, ENT_QUOTES, 'UTF-8', true);?>
" class="form-control" placeholder="" required="true" />
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group mb-2">
                                                                ...
                                                                <input type="text" class="form-control" name="social" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order']->value->social, ENT_QUOTES, 'UTF-8', true);?>
" placeholder="" />
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group mb-2 <?php if (in_array('empty_birth_place',(array)$_smarty_tpl->tpl_vars['contactdata_error']->value)) {?>has-danger<?php }?>">
                                                                ...
                                                                <input type="text" name="birth_place" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order']->value->birth_place, ENT_QUOTES, 'UTF-8', true);?>
" class="form-control" placeholder="" required="true" />
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group mb-1 <?php if (in_array('empty_passport_serial',(array)$_smarty_tpl->tpl_vars['contactdata_error']->value)) {?>has-danger<?php }?>">
                                                                ...
                                                                <input type="text" class="form-control" name="passport_serial" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order']->value->passport_serial, ENT_QUOTES, 'UTF-8', true);?>
" placeholder="" required="true" />
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group mb-1 <?php if (in_array('empty_passport_date',(array)$_smarty_tpl->tpl_vars['contactdata_error']->value)) {?>has-danger<?php }?>">
                                                                ...
                                                                <input type="text" class="form-control" name="passport_date" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order']->value->passport_date, ENT_QUOTES, 'UTF-8', true);?>
" placeholder="" required="true" />
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group mb-1 <?php if (in_array('empty_subdivision_code',(array)$_smarty_tpl->tpl_vars['contactdata_error']->value)) {?>has-danger<?php }?>">
                                                                ...
                                                                <input type="text" class="form-control" name="subdivision_code" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order']->value->subdivision_code, ENT_QUOTES, 'UTF-8', true);?>
" placeholder="" required="true" />
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group <?php if (in_array('empty_passport_issued',(array)$_smarty_tpl->tpl_vars['contactdata_error']->value)) {?>has-danger<?php }?>">
                                                                ...
                                                                <input type="text" class="form-control" name="passport_issued" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order']->value->passport_issued, ENT_QUOTES, 'UTF-8', true);?>
" placeholder="" required="true" />
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-actions">
                                                                <button type="submit" class="btn btn-success js-event-add-click" data-event="42" data-manager="<?php echo $_smarty_tpl->tpl_vars['manager']->value->id;?>
" data-order="<?php echo $_smarty_tpl->tpl_vars['order']->value->order_id;?>
" data-user="<?php echo $_smarty_tpl->tpl_vars['order']->value->user_id;?>
"> <i class="fa fa-check"></i> Сохранить</button>
                                                                <button type="button" class="btn btn-inverse js-cancel-edit">Отмена</button>
...
?>
                                                    ...
                                                    <?php if ($_smarty_tpl->tpl_vars['contactdata_is_changed']->value) {?>
                                                        <div class="mb-3 border">
                                                            <h5 class="card-header card-success" onclick="show_changes()">
...
?>
                                                ...
                                                <!-- /Контактные лица -->
                                                <form action="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0][0]->url_modifier(array(),$_smarty_tpl);?>
" class="js-order-item-form mb-3 border <?php if ($_smarty_tpl->tpl_vars['penalties']->value['contactpersons']&&$_smarty_tpl->tpl_vars['penalties']->value['contactpersons']->status!=3) {?>card-outline-danger<?php }?>" id="contact_persons_form">
...
" />
                                                    ...
                                                    <h5 class="card-header">
                                                        ...
                                                        <span class="float-right">
                                                            ...
                                                            <a href="javascript:void(0);" class="text-white js-edit-form js-event-add-click" data-event="33" data-manager="<?php echo $_smarty_tpl->tpl_vars['manager']->value->id;?>
" data-order="<?php echo $_smarty_tpl->tpl_vars['order']->value->order_id;?>
" data-user="<?php echo $_smarty_tpl->tpl_vars['order']->value->user_id;?>
"><i class=" fas fa-edit"></i></a></h3>
                                                        </span>
                                                    ...
                                                    <div class="row view-block m-0 <?php if ($_smarty_tpl->tpl_vars['contacts_error']->value) {?>hide<?php }?>">
                                                        <table class="table table-hover mb-0">
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <button class="js-mango-call mango-call js-event-add-click" data-phone="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order']->value->contact_person_phone, ENT_QUOTES, 'UTF-8', true);?>
" title="Выполнить звонок" data-event="61" data-manager="<?php echo $_smarty_tpl->tpl_vars['manager']->value->id;?>
" data-order="<?php echo $_smarty_tpl->tpl_vars['order']->value->order_id;?>
" data-user="<?php echo $_smarty_tpl->tpl_vars['order']->value->user_id;?>
">
                                                                        <i class="fas fa-mobile-alt"></i>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <button class="js-mango-call mango-call js-event-add-click" data-event="61" data-manager="<?php echo $_smarty_tpl->tpl_vars['manager']->value->id;?>
" data-order="<?php echo $_smarty_tpl->tpl_vars['order']->value->order_id;?>
" data-user="<?php echo $_smarty_tpl->tpl_vars['order']->value->user_id;?>
                                                    ...
                                                    <div class="row m-0 pt-2 pb-2 edit-block <?php if (!$_smarty_tpl->tpl_vars['contacts_error']->value) {?>hide<?php }?>">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group <?php if (in_array('empty_contact_person_name',(array)$_smarty_tpl->tpl_vars['contacts_error']->value)) {?>has-danger<?php }?>">
                                                                ...
                                                                <input type="text" class="form-control" name="contact_person_name" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order']->value->contact_person_name, ENT_QUOTES, 'UTF-8', true);?>
" placeholder="" required="true" />
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group <?php if (in_array('empty_contact_person_relation',(array)$_smarty_tpl->tpl_vars['contacts_error']->value)) {?>has-danger<?php }?>">
                                                                ...
                                                                <select class="form-control custom-select" name="contact_person_relation">
                                                                    <option value="" <?php if ($_smarty_tpl->tpl_vars['order']->value->contact_person_relation=='') {?>selected=""<?php }?>>Выберите значение</option>
                                                                    <option value="мать/отец" <?php if ($_smarty_tpl->tpl_vars['order']->value->contact_person_relation=='мать/отец') {?>selected=""<?php }?>>мать/отец</option>
                                                                    <option value="муж/жена" <?php if ($_smarty_tpl->tpl_vars['order']->value->contact_person_relation=='муж/жена') {?>selected=""<?php }?>>муж/жена</option>
                                                                    <option value="сын/дочь" <?php if ($_smarty_tpl->tpl_vars['order']->value->contact_person_relation=='сын/дочь') {?>selected=""<?php }?>>сын/дочь</option>
                                                                    <option value="коллега" <?php if ($_smarty_tpl->tpl_vars['order']->value->contact_person_relation=='коллега') {?>selected=""<?php }?>>коллега</option>
                                                                    <option value="друг/сосед" <?php if ($_smarty_tpl->tpl_vars['order']->value->contact_person_relation=='друг/сосед') {?>selected=""<?php }?>>друг/сосед</option>
                                                                    <option value="иной родственник" <?php if ($_smarty_tpl->tpl_vars['order']->value->contact_person_relation=='иной родственник') {?>selected=""<?php }?>>иной родственник</option>
                                                                </select>
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group <?php if (in_array('empty_contact_person_phone',(array)$_smarty_tpl->tpl_vars['contacts_error']->value)) {?>has-danger<?php }?>">
                                                                ...
                                                                <input type="text" class="form-control" name="contact_person_phone" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order']->value->contact_person_phone, ENT_QUOTES, 'UTF-8', true);?>
" placeholder="" required="true" />
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group <?php if (in_array('empty_contact_person2_name',(array)$_smarty_tpl->tpl_vars['contacts_error']->value)) {?>has-danger<?php }?>">
                                                                ...
                                                                <input type="text" class="form-control" name="contact_person2_name" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order']->value->contact_person2_name, ENT_QUOTES, 'UTF-8', true);?>
" placeholder="" required="true" />
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group <?php if (in_array('empty_contact_person_relation',(array)$_smarty_tpl->tpl_vars['contacts_error']->value)) {?>has-danger<?php }?>">
                                                                ...
                                                                <select class="form-control custom-select" name="contact_person2_relation">
                                                                    <option value="" <?php if ($_smarty_tpl->tpl_vars['order']->value->contact_person2_relation=='') {?>selected=""<?php }?>>Выберите значение</option>
                                                                    <option value="мать/отец" <?php if ($_smarty_tpl->tpl_vars['order']->value->contact_person2_relation=='мать/отец') {?>selected=""<?php }?>>мать/отец</option>
                                                                    <option value="муж/жена" <?php if ($_smarty_tpl->tpl_vars['order']->value->contact_person2_relation=='муж/жена') {?>selected=""<?php }?>>муж/жена</option>
                                                                    <option value="сын/дочь" <?php if ($_smarty_tpl->tpl_vars['order']->value->contact_person2_relation=='сын/дочь') {?>selected=""<?php }?>>сын/дочь</option>
                                                                    <option value="коллега" <?php if ($_smarty_tpl->tpl_vars['order']->value->contact_person2_relation=='коллега') {?>selected=""<?php }?>>коллега</option>
                                                                    <option value="друг/сосед" <?php if ($_smarty_tpl->tpl_vars['order']->value->contact_person2_relation=='друг/сосед') {?>selected=""<?php }?>>друг/сосед</option>
                                                                    <option value="иной родственник" <?php if ($_smarty_tpl->tpl_vars['order']->value->contact_person2_relation=='иной родственник') {?>selected=""<?php }?>>иной родственник</option>
                                                                </select>
                                                                <?php if (in_array('empty_contact_person_relation',(array)$_smarty_tpl->tpl_vars['contacts_error']->value)) {?><small class="form-control-feedback">Укажите кем приходится контакное лицо!</small><?php }?>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <div class="form-group <?php if (in_array('empty_contact_person2_phone',(array)$_smarty_tpl->tpl_vars['contacts_error']->value)) {?>has-danger<?php }?>">
                                                                ...
                                                                <input type="text" class="form-control" name="contact_person2_phone" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order']->value->contact_person2_phone, ENT_QUOTES, 'UTF-8', true);?>
" placeholder="" />
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-actions">
                                                                <button type="submit" class="btn btn-success js-event-add-click"  data-event="43" data-manager="<?php echo $_smarty_tpl->tpl_vars['manager']->value->id;?>
" data-order="<?php echo $_smarty_tpl->tpl_vars['order']->value->order_id;?>
" data-user="<?php echo $_smarty_tpl->tpl_vars['order']->value->user_id;?>
"> <i class="fa fa-check"></i> Сохранить</button>
                                                                <button type="button" class="btn btn-inverse js-cancel-edit">Отмена</button>
                                                ...
                                                <form action="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0][0]->url_modifier(array(),$_smarty_tpl);?>
" class="js-order-item-form mb-3 border <?php if ($_smarty_tpl->tpl_vars['penalties']->value['addresses']&&$_smarty_tpl->tpl_vars['penalties']->value['addresses']->status!=3) {?>card-outline-danger<?php }?>" id="address_form">
...
" />
                                                    ...
                                                    <h5 class="card-header">
                                                        ...
                                                        <span class="float-right">
                                                            ...
                                                            <a href="javascript:void(0);" class="text-white js-edit-form js-event-add-click" data-event="34" data-manager="<?php echo $_smarty_tpl->tpl_vars['manager']->value->id;?>
" data-order="<?php echo $_smarty_tpl->tpl_vars['order']->value->order_id;?>
" data-user="<?php echo $_smarty_tpl->tpl_vars['order']->value->user_id;?>
"><i class=" fas fa-edit"></i></a></h3>
                                                        </span>
                                                        ...
                                                        <div class="col-md-12">
                                                            <table class="table table-hover mb-0">
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <?php if ($_smarty_tpl->tpl_vars['order']->value->Regindex) {?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order']->value->Regindex, ENT_QUOTES, 'UTF-8', true);?>
, <?php }?>
                                                                        <?php echo $_smarty_tpl->tpl_vars['order']->value->Regregion;?>
 <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order']->value->Regregion_shorttype, ENT_QUOTES, 'UTF-8', true);?>
,
                                                                        <?php if ($_smarty_tpl->tpl_vars['order']->value->Regcity) {?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order']->value->Regcity, ENT_QUOTES, 'UTF-8', true);?>
 <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order']->value->Regcity_shorttype, ENT_QUOTES, 'UTF-8', true);?>
,<?php }?>
                                                                        <?php if ($_smarty_tpl->tpl_vars['order']->value->Regdistrict) {?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order']->value->Regdistrict, ENT_QUOTES, 'UTF-8', true);?>
 <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order']->value->Regdistrict_shorttype, ENT_QUOTES, 'UTF-8', true);?>
,<?php }?>
                                                                        <?php if ($_smarty_tpl->tpl_vars['order']->value->Reglocality) {?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order']->value->Reglocality_shorttype, ENT_QUOTES, 'UTF-8', true);?>
 <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order']->value->Reglocality, ENT_QUOTES, 'UTF-8', true);?>
,<?php }?>
                                                                        <?php echo $_smarty_tpl->tpl_vars['order']->value->Regstreet;?>
 <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order']->value->Regstreet_shorttype, ENT_QUOTES, 'UTF-8', true);?>
,
                                                                        д.<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order']->value->Reghousing, ENT_QUOTES, 'UTF-8', true);?>
,
                                                                        <?php if ($_smarty_tpl->tpl_vars['order']->value->Regbuilding) {?>стр. <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order']->value->Regbuilding, ENT_QUOTES, 'UTF-8', true);?>
,<?php }?>
                                                                        <?php if ($_smarty_tpl->tpl_vars['order']->value->Regroom) {?>кв.<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order']->value->Regroom, ENT_QUOTES, 'UTF-8', true);?>
<?php }?>                                                                
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <?php if ($_smarty_tpl->tpl_vars['order']->value->Faktindex) {?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order']->value->Faktindex, ENT_QUOTES, 'UTF-8', true);?>
, <?php }?>
                                                                        <?php echo $_smarty_tpl->tpl_vars['order']->value->Faktregion;?>
 <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order']->value->Faktregion_shorttype, ENT_QUOTES, 'UTF-8', true);?>
,
                                                                        <?php if ($_smarty_tpl->tpl_vars['order']->value->Faktcity) {?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order']->value->Faktcity, ENT_QUOTES, 'UTF-8', true);?>
 <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order']->value->Faktcity_shorttype, ENT_QUOTES, 'UTF-8', true);?>
,<?php }?>
                                                                        <?php if ($_smarty_tpl->tpl_vars['order']->value->Faktdistrict) {?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order']->value->Faktdistrict, ENT_QUOTES, 'UTF-8', true);?>
 <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order']->value->Faktdistrict_shorttype, ENT_QUOTES, 'UTF-8', true);?>
,<?php }?>
                                                                        <?php if ($_smarty_tpl->tpl_vars['order']->value->Faktlocality) {?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order']->value->Faktlocality_shorttype, ENT_QUOTES, 'UTF-8', true);?>
 <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order']->value->Faktlocality, ENT_QUOTES, 'UTF-8', true);?>
,<?php }?>
                                                                        <?php if ($_smarty_tpl->tpl_vars['order']->value->Faktstreet) {?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order']->value->Faktstreet, ENT_QUOTES, 'UTF-8', true);?>
 <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order']->value->Faktstreet_shorttype, ENT_QUOTES, 'UTF-8', true);?>
,<?php }?>
                                                                        д.<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order']->value->Fakthousing, ENT_QUOTES, 'UTF-8', true);?>
,
                                                                        <?php if ($_smarty_tpl->tpl_vars['order']->value->Faktbuilding) {?>стр. <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order']->value->Faktbuilding, ENT_QUOTES, 'UTF-8', true);?>
,<?php }?>
                                                                        <?php if ($_smarty_tpl->tpl_vars['order']->value->Faktroom) {?>кв.<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order']->value->Faktroom, ENT_QUOTES, 'UTF-8', true);?>
<?php }?>
                                                                    </td>
                                                                </tr>
                                                            </table>
...
" placeholder=""/>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group mb-1 <?php if (in_array('empty_regregion',(array)$_smarty_tpl->tpl_vars['addresses_error']->value)) {?>has-danger<?php }?>">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-9">
                                                                            <input type="text" class="form-control js-dadata-region" name="Regregion" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order']->value->Regregion, ENT_QUOTES, 'UTF-8', true);?>
" placeholder="" required="true" />
                                                                        </div>
                                                                        <div class="col-3">
                                                                            <input type="text" class="form-control js-dadata-region-type" name="Regregion_shorttype" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order']->value->Regregion_shorttype, ENT_QUOTES, 'UTF-8', true);?>
" placeholder="" />
                                                                        </div>
                                                                    </div>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group mb-1 <?php if (in_array('empty_regcity',(array)$_smarty_tpl->tpl_vars['addresses_error']->value)) {?>has-danger<?php }?>">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-9">
                                                                            <input type="text" class="form-control js-dadata-city" name="Regcity" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order']->value->Regcity, ENT_QUOTES, 'UTF-8', true);?>
" placeholder="" />
                                                                        </div>
                                                                        <div class="col-3">
                                                                            <input type="text" class="form-control js-dadata-city-type" name="Regcity_shorttype" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order']->value->Regcity_shorttype, ENT_QUOTES, 'UTF-8', true);?>
" placeholder="" />
                                                                        </div>
                                                                    </div>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group mb-1 ">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-9">
                                                                            <input type="text" class="form-control js-dadata-district" name="Regdistrict" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order']->value->Regdistrict, ENT_QUOTES, 'UTF-8', true);?>
" placeholder=""/>
                                                                        </div>
                                                                        <div class="col-3">
                                                                            <input type="text" class="form-control js-dadata-district-type" name="Regdistrict_shorttype" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order']->value->Regdistrict_shorttype, ENT_QUOTES, 'UTF-8', true);?>
" placeholder="" />
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group mb-1 ">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-9">
                                                                            <input type="text" class="form-control js-dadata-locality" name="Reglocality" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order']->value->Reglocality, ENT_QUOTES, 'UTF-8', true);?>
" placeholder="" />
                                                                        </div>
                                                                        <div class="col-3">
                                                                            <input type="text" class="form-control js-dadata-locality-type" name="Reglocality_shorttype" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order']->value->Reglocality_shorttype, ENT_QUOTES, 'UTF-8', true);?>
" placeholder="" />
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group mb-1 <?php if (in_array('empty_regstreet',(array)$_smarty_tpl->tpl_vars['addresses_error']->value)) {?>has-danger<?php }?>">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-9">
                                                                            <input type="text" class="form-control js-dadata-street" name="Regstreet" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order']->value->Regstreet, ENT_QUOTES, 'UTF-8', true);?>
" placeholder="" />
                                                                        </div>
                                                                        <div class="col-3">
                                                                            <input type="text" class="form-control js-dadata-street-type" name="Regstreet_shorttype" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order']->value->Regstreet_shorttype, ENT_QUOTES, 'UTF-8', true);?>
" placeholder="" />
                                                                        </div>
                                                                    </div>
                                                            ...
                                                            <div class="col-md-3">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control js-dadata-index" name="Regindex" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order']->value->Regindex, ENT_QUOTES, 'UTF-8', true);?>
" placeholder="" />
                                                                </div>
                                                            </div>
                                                            <div class="col-md-3">
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="form-group <?php if (in_array('empty_reghousing',(array)$_smarty_tpl->tpl_vars['addresses_error']->value)) {?>has-danger<?php }?>">
                                                                    ...
                                                                    <input type="text" class="form-control js-dadata-house" name="Reghousing" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order']->value->Reghousing, ENT_QUOTES, 'UTF-8', true);?>
" placeholder="" />
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control js-dadata-building" name="Regbuilding" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order']->value->Regbuilding, ENT_QUOTES, 'UTF-8', true);?>
" placeholder="" />
                                                                </div>
                                                            </div>
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control js-dadata-room" name="Regroom" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order']->value->Regroom, ENT_QUOTES, 'UTF-8', true);?>
" placeholder="" />
                                                                </div>
                                                            </div>
...
" placeholder=""/>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group mb-1 <?php if (in_array('empty_faktregion',(array)$_smarty_tpl->tpl_vars['addresses_error']->value)) {?>has-danger<?php }?>">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-9">
                                                                            <input type="text" class="form-control js-dadata-region" name="Faktregion" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order']->value->Faktregion, ENT_QUOTES, 'UTF-8', true);?>
" placeholder="" required="true" />
                                                                        </div>
                                                                        <div class="col-3">
                                                                            <input type="text" class="form-control js-dadata-region-type" name="Faktregion_shorttype" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order']->value->Faktregion_shorttype, ENT_QUOTES, 'UTF-8', true);?>
" placeholder="" />
                                                                        </div>
                                                                    </div>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group mb-1 <?php if (in_array('empty_faktcity',(array)$_smarty_tpl->tpl_vars['addresses_error']->value)) {?>has-danger<?php }?>">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-9">
                                                                            <input type="text" class="form-control js-dadata-city" name="Faktcity" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order']->value->Faktcity, ENT_QUOTES, 'UTF-8', true);?>
" placeholder=""  />
                                                                        </div>
                                                                        <div class="col-3">
                                                                            <input type="text" class="form-control js-dadata-city-type" name="Faktcity_shorttype" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order']->value->Faktcity_shorttype, ENT_QUOTES, 'UTF-8', true);?>
" placeholder="" />
                                                                        </div>
                                                                    </div>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group mb-1 ">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-9">
                                                                            <input type="text" class="form-control js-dadata-district" name="Faktdistrict" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order']->value->Faktdistrict, ENT_QUOTES, 'UTF-8', true);?>
" placeholder="" />
                                                                        </div>
                                                                        <div class="col-3">
                                                                            <input type="text" class="form-control js-dadata-district-type" name="Faktdistrict_shorttype" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order']->value->Faktdistrict_shorttype, ENT_QUOTES, 'UTF-8', true);?>
" placeholder="" />
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group mb-1 ">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-9">
                                                                            <input type="text" class="form-control js-dadata-locality" name="Faktlocality" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order']->value->Faktlocality, ENT_QUOTES, 'UTF-8', true);?>
" placeholder="" />
                                                                        </div>
                                                                        <div class="col-3">
                                                                            <input type="text" class="form-control js-dadata-locality-type" name="Faktlocality_shorttype" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order']->value->Faktlocality_shorttype, ENT_QUOTES, 'UTF-8', true);?>
" placeholder="" />
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group mb-1 <?php if (in_array('empty_faktstreet',(array)$_smarty_tpl->tpl_vars['addresses_error']->value)) {?>has-danger<?php }?>">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-9">
                                                                            <input type="text" class="form-control js-dadata-street" name="Faktstreet" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order']->value->Faktstreet, ENT_QUOTES, 'UTF-8', true);?>
" placeholder=""  />
                                                                        </div>
                                                                        <div class="col-3">
                                                                            <input type="text" class="form-control js-dadata-street-type" name="Faktstreet_shorttype" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order']->value->Faktstreet_shorttype, ENT_QUOTES, 'UTF-8', true);?>
" placeholder="" />
                                                                        </div>
                                                                    </div>
                                                            ...
                                                            <div class="col-md-3">
                                                                <div class="form-group">
                                                                    <label class="control-label">Индекс</label>
                                                                    <input type="text" class="form-control js-dadata-index" name="Faktindex" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order']->value->Faktindex, ENT_QUOTES, 'UTF-8', true);?>
" placeholder="" />
                                                                </div>
                                                            </div>
                                                            <div class="col-md-3">
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="form-group <?php if (in_array('empty_fakthousing',(array)$_smarty_tpl->tpl_vars['addresses_error']->value)) {?>has-danger<?php }?>">
                                                                    <label class="control-label">Дом</label>
                                                                    <input type="text" class="form-control js-dadata-house" name="Fakthousing" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order']->value->Fakthousing, ENT_QUOTES, 'UTF-8', true);?>
" placeholder="" />
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                                    <label class="control-label">Строение</label>
                                                                    <input type="text" class="form-control js-dadata-building" name="Faktbuilding" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order']->value->Faktbuilding, ENT_QUOTES, 'UTF-8', true);?>
" placeholder="" />
                                                                </div>
                                                            </div>
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                                    <label class="control-label">Квартира</label>
                                                                    <input type="text" class="form-control js-dadata-room" name="Faktroom" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order']->value->Faktroom, ENT_QUOTES, 'UTF-8', true);?>
" placeholder=""  />
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row m-0 mt-2 mb-2">
                                                            <div class="col-md-12">
                                                                <div class="form-actions">
                                                                    <button type="submit" class="btn btn-success js-event-add-click" data-event="44" data-manager="<?php echo $_smarty_tpl->tpl_vars['manager']->value->id;?>
" data-order="<?php echo $_smarty_tpl->tpl_vars['order']->value->order_id;?>
" data-user="<?php echo $_smarty_tpl->tpl_vars['order']->value->user_id;?>
"> <i class="fa fa-check"></i> Сохранить</button>
                                                                    <button type="button" class="btn btn-inverse js-cancel-edit">Отмена</button>
                                                ...
                                                <!-- Данные о работе -->
                                                <form action="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0][0]->url_modifier(array(),$_smarty_tpl);?>
" class="border js-order-item-form mb-3 <?php if ($_smarty_tpl->tpl_vars['penalties']->value['work']&&$_smarty_tpl->tpl_vars['penalties']->value['work']->status!=3) {?>card-outline-danger<?php }?>" id="work_data_form">
...
" />
                                                    ...
                                                    <h5 class="card-header">
                                                        ...
                                                        <span class="float-right">
                                                            ...
                                                            <a href="javascript:void(0);" class="text-white float-right js-edit-form js-event-add-click" data-event="35" data-manager="<?php echo $_smarty_tpl->tpl_vars['manager']->value->id;?>
" data-order="<?php echo $_smarty_tpl->tpl_vars['order']->value->order_id;?>
" data-user="<?php echo $_smarty_tpl->tpl_vars['order']->value->user_id;?>
"><i class=" fas fa-edit"></i></a>
                                                        </span>
                                                                    ...
                                                                    <p class="form-control-static">
                                                                        <span class="clearfix">
                                                                            ...
                                                                            <span class="float-right">
                                                                                ...
                                                                                <button class="js-mango-call mango-call js-event-add-click" data-event="62" data-manager="<?php echo $_smarty_tpl->tpl_vars['manager']->value->id;?>
" data-order="<?php echo $_smarty_tpl->tpl_vars['order']->value->order_id;?>
" data-user="<?php echo $_smarty_tpl->tpl_vars['order']->value->user_id;?>
...
, <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order']->value->chief_position, ENT_QUOTES, 'UTF-8', true);?>
                                                                        ...
                                                                        <button class="js-mango-call mango-call js-event-add-click" data-event="63" data-manager="<?php echo $_smarty_tpl->tpl_vars['manager']->value->id;?>
" data-order="<?php echo $_smarty_tpl->tpl_vars['order']->value->order_id;?>
" data-user="<?php echo $_smarty_tpl->tpl_vars['order']->value->user_id;?>
                                                    ...
                                                    <div class="row m-0 pt-2 edit-block js-dadata-address <?php if (!$_smarty_tpl->tpl_vars['work_error']->value) {?>hide<?php }?>">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group mb-0 <?php if (in_array('empty_workplace',(array)$_smarty_tpl->tpl_vars['work_error']->value)) {?>has-danger<?php }?>">
                                                                ...
                                                                <input type="text" class="form-control" name="workplace" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order']->value->workplace, ENT_QUOTES, 'UTF-8', true);?>
" placeholder="" required="true" />
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group mb-0 <?php if (in_array('empty_profession',(array)$_smarty_tpl->tpl_vars['work_error']->value)) {?>has-danger<?php }?>">
                                                                ...
                                                                <input type="text" class="form-control" name="profession" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order']->value->profession, ENT_QUOTES, 'UTF-8', true);?>
" placeholder="" required="true" />
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group mb-0">
                                                                ...
                                                                <input type="text" class="form-control" name="workaddress" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order']->value->workaddress, ENT_QUOTES, 'UTF-8', true);?>
" placeholder="" required="true" />
                                                            </div>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <div class="form-group mb-0 <?php if (in_array('empty_workphone',(array)$_smarty_tpl->tpl_vars['work_error']->value)) {?>has-danger<?php }?>">
                                                                ...
                                                                <input type="text" class="form-control" name="workphone" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order']->value->workphone, ENT_QUOTES, 'UTF-8', true);?>
" placeholder="" required="true" />
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group mb-0 <?php if (in_array('empty_income',(array)$_smarty_tpl->tpl_vars['work_error']->value)) {?>has-danger<?php }?>">
                                                                ...
                                                                <input type="text" class="form-control" name="income" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order']->value->income, ENT_QUOTES, 'UTF-8', true);?>
" placeholder="" required="true" />
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group mb-0 <?php if (in_array('empty_expenses',(array)$_smarty_tpl->tpl_vars['work_error']->value)) {?>has-danger<?php }?>">
                                                                ...
                                                                <input type="text" class="form-control" name="expenses" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order']->value->expenses, ENT_QUOTES, 'UTF-8', true);?>
" placeholder="" required="true" />
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group mb-0 <?php if (in_array('empty_chief_name',(array)$_smarty_tpl->tpl_vars['work_error']->value)) {?>has-danger<?php }?>">
                                                                ...
                                                                <input type="text" class="form-control" name="chief_name" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order']->value->chief_name, ENT_QUOTES, 'UTF-8', true);?>
" placeholder="" required="true" />
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group mb-0 <?php if (in_array('empty_chief_position',(array)$_smarty_tpl->tpl_vars['work_error']->value)) {?>has-danger<?php }?>">
                                                                ...
                                                                <input type="text" class="form-control" name="chief_position" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order']->value->chief_position, ENT_QUOTES, 'UTF-8', true);?>
" placeholder="" required="true" />
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group mb-0 <?php if (in_array('empty_chief_phone',(array)$_smarty_tpl->tpl_vars['work_error']->value)) {?>has-danger<?php }?>">
                                                                ...
                                                                <input type="text" class="form-control" name="chief_phone" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order']->value->chief_phone, ENT_QUOTES, 'UTF-8', true);?>
" placeholder="" />
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group mb-0">
                                                                ...
                                                                <input type="text" class="form-control" name="workcomment" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order']->value->workcomment, ENT_QUOTES, 'UTF-8', true);?>
" placeholder="" />
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-12 pb-2 mt-2">
                                                            <div class="form-actions">
                                                                <button type="submit" class="btn btn-success js-event-add-click" data-event="45" data-manager="<?php echo $_smarty_tpl->tpl_vars['manager']->value->id;?>
" data-order="<?php echo $_smarty_tpl->tpl_vars['order']->value->order_id;?>
" data-user="<?php echo $_smarty_tpl->tpl_vars['order']->value->user_id;?>
"> <i class="fa fa-check"></i> Сохранить</button>
                                                                <button type="button" class="btn btn-inverse js-cancel-edit">Отмена</button>
                                            ...
                                            <div class="col-md-4 ">
                                                ...
                                                <div class="card mb-1 <?php if ($_smarty_tpl->tpl_vars['order']->value->autoretry_summ) {?>card-success<?php } else { ?>card-danger<?php }?>">
                                                    <div class="box ">
                                                        <h5 class="card-title mb-0 text-white text-center">Авторешение</h5>
...
" class="mt-2 btn btn-block btn-info btn-sm js-autoretry-accept js-event-add-click" data-event="17" data-manager="<?php echo $_smarty_tpl->tpl_vars['manager']->value->id;?>
" data-order="<?php echo $_smarty_tpl->tpl_vars['order']->value->order_id;?>
" data-user="<?php echo $_smarty_tpl->tpl_vars['order']->value->user_id;?>
">
                                                ...
                                                <div class="mb-3 border  <?php if ($_smarty_tpl->tpl_vars['penalties']->value['scorings']&&$_smarty_tpl->tpl_vars['penalties']->value['scorings']->status!=3) {?>card-outline-danger<?php }?>">
                                                    <h5 class=" card-header">
                                                        ...
                                                        <span class="float-right">
                                                            ...
                                                            <a class="text-white js-run-scorings" data-type="all" data-order="<?php echo $_smarty_tpl->tpl_vars['order']->value->order_id;?>
" href="javascript:void(0);">
                                                    ...
                                                    <div class="message-box js-scorings-block <?php if ($_smarty_tpl->tpl_vars['need_update_scorings']->value) {?>js-need-update<?php }?>" data-order="<?php echo $_smarty_tpl->tpl_vars['order']->value->order_id;?>
">
                                                                    ...
                                                                    <div class="col-12 col-sm-12 pt-2">
                                                                        <h5 class="float-left">
                                                                            ...
                                                                            <?php if ($_smarty_tpl->tpl_vars['scoring_type']->value->name=='fssp') {?>
                                                                                <?php if ($_smarty_tpl->tpl_vars['scorings']->value[$_smarty_tpl->tpl_vars['scoring_type']->value->name]->found_46) {?><span class="label label-danger">46</span><?php }?>
                                                                                <?php if ($_smarty_tpl->tpl_vars['scorings']->value[$_smarty_tpl->tpl_vars['scoring_type']->value->name]->found_47) {?><span class="label label-danger">47</span><?php }?>
                                                                            <?php }?>
                                                                        </h5>
                                                                        ...
                                                                        <?php } elseif ($_smarty_tpl->tpl_vars['scorings']->value[$_smarty_tpl->tpl_vars['scoring_type']->value->name]->status=='error'||$_smarty_tpl->tpl_vars['scorings']->value[$_smarty_tpl->tpl_vars['scoring_type']->value->name]->status=='stopped') {?>
...
">
                                                                            ...
                                                                            <?php if ($_smarty_tpl->tpl_vars['scoring_type']->value->name=='nbki') {?>
                                                                                ...
                                                                                <span class="mail-desc" title="<?php echo $_smarty_tpl->tpl_vars['scorings']->value[$_smarty_tpl->tpl_vars['scoring_type']->value->name]->body['number_of_active'][1];?>
...
">
                                                                                ...
                                                                                <span class="mail-desc" title="<?php echo $_smarty_tpl->tpl_vars['number_of_active']->value;?>
">
 ...
 <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['time'][0][0]->time_modifier($_smarty_tpl->tpl_vars['scorings']->value[$_smarty_tpl->tpl_vars['scoring_type']->value->name]->created);?>
                                                                            ...
                                                                            <?php }?>
                                                                            <?php if ($_smarty_tpl->tpl_vars['scoring_type']->value->name=='fssp') {?>
                                                                                <a href="javascript:void(0);" class="js-get-fssp-info float-right" data-scoring="<?php echo $_smarty_tpl->tpl_vars['scorings']->value[$_smarty_tpl->tpl_vars['scoring_type']->value->name]->id;?>
">Подробнее</a>
                                                                            <?php }?>
...
&password=Hjkdf8d" target="_blank">Подробнее</a>
                                                                            <?php }?>
...
" target="_blank" class="float-right">Подробнее</a>
                                                                                <?php } ?>
                                                                            <?php }?>
                                                                            <?php if ($_smarty_tpl->tpl_vars['scoring_type']->value->name=='nbki') {?>
...
?api=F1h1Hdf9g_h" target="_blank">Подробнее</a>
                                                                            <?php }?>
                                                                        </span>
                                                                    </div>
                                                                    ...
                                                                    <?php if ($_smarty_tpl->tpl_vars['order']->value->status<2||$_smarty_tpl->tpl_vars['is_developer']->value) {?>
                                                                        <?php if ($_smarty_tpl->tpl_vars['scorings']->value[$_smarty_tpl->tpl_vars['scoring_type']->value->name]->status=='new'||$_smarty_tpl->tpl_vars['scorings']->value[$_smarty_tpl->tpl_vars['scoring_type']->value->name]->status=='process') {?>
                                                                            <a class="btn-load text-info run-scoring-btn float-right" data-type="<?php echo $_smarty_tpl->tpl_vars['scoring_type']->value->name;?>
" data-order="<?php echo $_smarty_tpl->tpl_vars['order']->value->order_id;?>
" href="javascript:void(0);">
                                                                                <div class="spinner-border text-info" role="status"></div>
                                                                            </a>
                                                                        <?php } elseif ($_smarty_tpl->tpl_vars['scorings']->value[$_smarty_tpl->tpl_vars['scoring_type']->value->name]) {?>
                                                                            <a class="btn-load text-info js-run-scorings run-scoring-btn float-right" data-type="<?php echo $_smarty_tpl->tpl_vars['scoring_type']->value->name;?>
" data-order="<?php echo $_smarty_tpl->tpl_vars['order']->value->order_id;?>
" href="javascript:void(0);">
                                                                                <i class="fas fa-undo"></i>
                                                                            </a>
                                                                        <?php } else { ?>
                                                                            <a class="btn-load <?php if (in_array($_smarty_tpl->tpl_vars['scoring_type']->value->name,$_smarty_tpl->tpl_vars['audit_types']->value)) {?>loading<?php }?> text-info js-run-scorings run-scoring-btn float-right" data-type="<?php echo $_smarty_tpl->tpl_vars['scoring_type']->value->name;?>
" data-order="<?php echo $_smarty_tpl->tpl_vars['order']->value->order_id;?>
" href="javascript:void(0);">
                                                                                <i class="far fa-play-circle"></i>
                                                                            </a>
                                                ...
                                                <form action="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0][0]->url_modifier(array(),$_smarty_tpl);?>
" class="mb-3 border js-order-item-form <?php if ($_smarty_tpl->tpl_vars['penalties']->value['services']&&$_smarty_tpl->tpl_vars['penalties']->value['services']->status!=3) {?>card-outline-danger<?php }?>" id="services_form">
...
" />
                                                    ...
                                                    <h5 class="card-header text-white">
                                                        ...
                                                        <span class="float-right ">
                                                            ...
                                                            <a href="javascript:void(0);" class="js-edit-form text-white js-event-add-click" data-event="36" data-manager="<?php echo $_smarty_tpl->tpl_vars['manager']->value->id;?>
" data-order="<?php echo $_smarty_tpl->tpl_vars['order']->value->order_id;?>
" data-user="<?php echo $_smarty_tpl->tpl_vars['order']->value->user_id;?>
"><i class=" fas fa-edit"></i></a>
                                                        </span>
                                                            ...
                                                            <div class="form-group mb-0 row">
                                                                <label class="control-label col-md-8 col-7">
                                                                    ...
                                                                    <span class="label label-custom">Z</span>
                                                                        ...
                                                                        <?php } else { ?>
                                                                        <button class="btn btn-xs btn-danger js-return-insure" data-contract="<?php echo $_smarty_tpl->tpl_vars['contract']->value->id;?>
" type="button">Вернуть</button>
                                                    ...
                                                    <div class="row p-2 edit-block <?php if (!$_smarty_tpl->tpl_vars['services_error']->value) {?>hide<?php }?>">
                                                        <div class="col-md-12">
                                                            ...
                                                            <div class="form-group">
                                                                <div class="custom-control custom-switch">
                                                                    <input type="checkbox" class="custom-control-input" name="service_reason" id="service_reason" value="1" <?php if ($_smarty_tpl->tpl_vars['order']->value->service_reason) {?>checked="true"<?php }?> />
                                                                    <label class="custom-control-label" for="service_reason">Причина отказа</label>
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <div class="custom-control custom-switch">
                                                                    <input type="checkbox" class="custom-control-input" name="service_insurance" id="service_insurance" value="1" <?php if ($_smarty_tpl->tpl_vars['order']->value->service_insurance) {?>checked="true"<?php }?> />
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-actions">
                                                                <button type="submit" class="btn btn-success js-event-add-click" data-event="46" data-manager="<?php echo $_smarty_tpl->tpl_vars['manager']->value->id;?>
" data-order="<?php echo $_smarty_tpl->tpl_vars['order']->value->order_id;?>
" data-user="<?php echo $_smarty_tpl->tpl_vars['order']->value->user_id;?>
"> <i class="fa fa-check"></i> Сохранить</button>
                                                                <button type="button" class="btn btn-inverse js-cancel-edit">Отмена</button>
                                                ...
                                                <form action="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0][0]->url_modifier(array(),$_smarty_tpl);?>
" class="mb-3 border js-order-item-form <?php if ($_smarty_tpl->tpl_vars['penalties']->value['cards']&&$_smarty_tpl->tpl_vars['penalties']->value['cards']->status!=3) {?>card-outline-danger<?php }?>" id="cards_form">
...
" />
                                                    ...
                                                    <h5 class="card-header text-white">
                                                        ...
                                                        <span class="float-right">
                                                            ...
                                                            <a href="javascript:void(0);" class="js-edit-form text-white js-event-add-click" data-event="37" data-manager="<?php echo $_smarty_tpl->tpl_vars['manager']->value->id;?>
" data-order="<?php echo $_smarty_tpl->tpl_vars['order']->value->order_id;?>
" data-user="<?php echo $_smarty_tpl->tpl_vars['order']->value->user_id;?>
"><i class=" fas fa-edit"></i></a>
                                                            <?php }?>
...
" class="text-danger" target="_blank">Найдено совпадение</a>
                                                                    <?php } ?>
                                                                </div>
                                                                <?php }?>
                                                            </div>
...
" <?php if ($_smarty_tpl->tpl_vars['card']->value->id==$_smarty_tpl->tpl_vars['order']->value->card_id) {?>selected<?php }?>>
 ...
 <?php echo $_smarty_tpl->tpl_vars['card']->value->expdate;?>
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-actions">
                                                                <button type="submit" class="btn btn-success js-event-add-click" data-event="47" data-manager="<?php echo $_smarty_tpl->tpl_vars['manager']->value->id;?>
" data-order="<?php echo $_smarty_tpl->tpl_vars['order']->value->order_id;?>
" data-user="<?php echo $_smarty_tpl->tpl_vars['order']->value->user_id;?>
"> <i class="fa fa-check"></i> Сохранить</button>
                                                                <button type="button" class="btn btn-inverse js-cancel-edit">Отмена</button>
                                        ...
                                        <form action="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0][0]->url_modifier(array(),$_smarty_tpl);?>
" class="border js-order-item-form mb-3 js-check-images <?php if ($_smarty_tpl->tpl_vars['penalties']->value['images']&&$_smarty_tpl->tpl_vars['penalties']->value['images']->status!=3) {?>card-outline-danger<?php }?>" id="images_form" data-user="<?php echo $_smarty_tpl->tpl_vars['order']->value->user_id;?>
">
...
?>
 ...
 js-image-item" data-status="<?php echo $_smarty_tpl->tpl_vars['file']->value->status;?>
...
">
                                                        <a class="js-open-popup-image image-popup-fit-width js-event-add-click" data-event="50" data-manager="<?php echo $_smarty_tpl->tpl_vars['manager']->value->id;?>
" data-order="<?php echo $_smarty_tpl->tpl_vars['order']->value->order_id;?>
" data-user="<?php echo $_smarty_tpl->tpl_vars['order']->value->user_id;?>
" data-fancybox="user_image" href="<?php echo $_smarty_tpl->tpl_vars['config']->value->front_url;?>
                                                            ...
                                                            <div class="dropdown mr-1 show ">
                                                                ...
                                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuOffset" x-placement="bottom-start" >
                                                                    <div class="p-1 dropdown-item">
                                                                        <button class="btn btn-sm btn-block btn-outline-success js-image-accept js-event-add-click" data-event="51" data-manager="<?php echo $_smarty_tpl->tpl_vars['manager']->value->id;?>
" data-order="<?php echo $_smarty_tpl->tpl_vars['order']->value->order_id;?>
" data-user="<?php echo $_smarty_tpl->tpl_vars['order']->value->user_id;?>
" data-id="<?php echo $_smarty_tpl->tpl_vars['file']->value->id;?>
" type="button">
                                                                    ...
                                                                    <div class="p-1 dropdown-item">
                                                                        <button class="btn btn-sm btn-block btn-outline-danger js-image-reject js-event-add-click" data-event="52" data-manager="<?php echo $_smarty_tpl->tpl_vars['manager']->value->id;?>
" data-order="<?php echo $_smarty_tpl->tpl_vars['order']->value->order_id;?>
" data-user="<?php echo $_smarty_tpl->tpl_vars['order']->value->user_id;?>
" data-id="<?php echo $_smarty_tpl->tpl_vars['file']->value->id;?>
" type="button">
                                                                    ...
                                                                    <div class="p-1 pt-3 dropdown-item">
                                                                        <button class="btn btn-sm btn-block btn-danger js-image-remove js-event-add-click" data-event="53" data-manager="<?php echo $_smarty_tpl->tpl_vars['manager']->value->id;?>
" data-order="<?php echo $_smarty_tpl->tpl_vars['order']->value->order_id;?>
" data-user="<?php echo $_smarty_tpl->tpl_vars['order']->value->user_id;?>
" data-user="<?php echo $_smarty_tpl->tpl_vars['order']->value->user_id;?>
" data-id="<?php echo $_smarty_tpl->tpl_vars['file']->value->id;?>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6 col-lg-8">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="js-file-status" id="status_<?php echo $_smarty_tpl->tpl_vars['file']->value->id;?>
...
" />
                                        ...
                                        <form  method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="form_file_item">
                                                <input type="file" name="new_file" id="new_file" data-user="<?php echo $_smarty_tpl->tpl_vars['order']->value->user_id;?>
                                                    ...
                                                    <a href="javascript:void(0);">
                                                        ...
                                                        <div class="mail-contnet">
                                                            <div class="clearfix">
                                                                ...
                                                                <?php if ($_smarty_tpl->tpl_vars['comment']->value->official) {?><span class="label label-success">Оффициальный</span><?php }?>
                                                                <?php if ($_smarty_tpl->tpl_vars['comment']->value->organization=='mkk') {?><span class="label label-info">МКК</span><?php }?>
                                                                <?php if ($_smarty_tpl->tpl_vars['comment']->value->organization=='yuk') {?><span class="label label-danger">ЮК</span><?php }?>
                                                            </div>
...
?>
 ...
 руб</strong>
                                                    ...
                                                    <td><strong><?php echo $_smarty_tpl->tpl_vars['operation']->value->loan_body_summ+$_smarty_tpl->tpl_vars['operation']->value->loan_percents_summ+$_smarty_tpl->tpl_vars['operation']->value->loan_charge_summ+$_smarty_tpl->tpl_vars['operation']->value->loan_peni_summ;?>
</strong></td>
                                                </tr>
                                                <?php } ?>
                                            </tbody>
...
" target="_blank"><?php echo $_smarty_tpl->tpl_vars['o']->value->order_id;?>
                                                                    ...
                                                                    <td class="text-right">
                                                                        ...
                                                                        <?php }?>
                                                                        <?php if ($_smarty_tpl->tpl_vars['o']->value->contract->status==3) {?><br /><small><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['date'][0][0]->date_modifier($_smarty_tpl->tpl_vars['o']->value->contract->close_date);?>
                                ...
                                <div class="tab-pane p-3" id="connexions" role="tabpanel">
                                    <div class="row pb-2">
                                        ...
                                        <div class="col-6 text-right">
                                            <button class="btn btn-loading btn-info js-run-connexions" data-user="<?php echo $_smarty_tpl->tpl_vars['order']->value->user_id;?>
" type="button">
...
" target="_blank"><small><?php echo $_smarty_tpl->tpl_vars['communication']->value->order->order_id;?>
</small></a>
                                                        <?php }?>
                                                    </td>
                                                    <td >
                                                    ...
                                                    <td>
                                                        <?php if ($_smarty_tpl->tpl_vars['communication']->value->yuk) {?><span class="label label-info">ЮК</span>
                                                        <?php } else { ?><span class="label label-success">МКК</span><?php }?>
                                                    </td>
                                                    <td>
...
" />
                    ...
                    <div class="form-action">
                        <button type="button" class="btn btn-danger waves-effect js-event-add-click" data-event="70" data-manager="<?php echo $_smarty_tpl->tpl_vars['manager']->value->id;?>
" data-order="<?php echo $_smarty_tpl->tpl_vars['order']->value->order_id;?>
" data-user="<?php echo $_smarty_tpl->tpl_vars['order']->value->user_id;?>
...
" />
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="close_date" required="" placeholder="ДД.ММ.ГГГГ" value="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['date'][0][0]->date_modifier('');?>
" />
                    </div>
                    <div class="form-group">
...
" />
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-6">
                                <input type="text" class="form-control" name="od" required="" value="<?php echo $_smarty_tpl->tpl_vars['contract']->value->loan_body_summ;?>
" />
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-6">
                                <input type="text" class="form-control" name="percents" required="" value="<?php echo $_smarty_tpl->tpl_vars['contract']->value->loan_percents_summ;?>
" />
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-6">
                                <input type="text" class="form-control" name="charge" required="" value="<?php echo $_smarty_tpl->tpl_vars['contract']->value->loan_charge_summ;?>
" />
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-6">
                                <input type="text" class="form-control" name="peni" required="" value="<?php echo $_smarty_tpl->tpl_vars['contract']->value->loan_peni_summ;?>
" />
                            </div>
                        </div>
                    </div>
