<?php /* Smarty version Smarty-3.1.18, created on 2022-10-10 13:28:36
         compiled from "/home/e/ecofinance/lucky_crm/public_html/theme/manager/html/collector_contracts.tpl" */ ?>
<?php /*%%SmartyHeaderCode:685048486343f3d4cdce62-70818098%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'af9f7d3ba8dd9ff432123f96db6c32d7cb212504' => 
    array (
      0 => '/home/e/ecofinance/lucky_crm/public_html/theme/manager/html/collector_contracts.tpl',
      1 => 1660295914,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '685048486343f3d4cdce62-70818098',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_6343f3d4d99772_17444843',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_6343f3d4d99772_17444843')) {function content_6343f3d4d99772_17444843($_smarty_tpl) {?><?php $_smarty_tpl->tpl_vars['meta_title'] = new Smarty_variable('Мои договоры', null, 1);
                    ...
                    <div class="card-body">
                        <div class="clearfix">
                            ...
                            <div class="float-right js-filter-client">
                                ...
                                <a href="<?php if ($_smarty_tpl->tpl_vars['filter_status']->value=='all') {?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0][0]->url_modifier(array('status'=>null,'page'=>null),$_smarty_tpl);?>
<?php } else { ?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0][0]->url_modifier(array('status'=>'all','page'=>null),$_smarty_tpl);?>
<?php }?>" class="btn btn-xs <?php if ($_smarty_tpl->tpl_vars['filter_status']->value=='all') {?>btn-success<?php } else { ?>btn-outline-success<?php }?>">Все договора</a>
...
" type="button" title="Подробнее"></button>
                                                ...
                                                <div style="padding-left:20px;"> 
                                                    <?php if ($_smarty_tpl->tpl_vars['contract']->value->status==3) {?>
                                                        <span class="label label-success">Закрыт</span>
                                                    <?php } elseif ($_smarty_tpl->tpl_vars['contract']->value->collection_status) {?>
