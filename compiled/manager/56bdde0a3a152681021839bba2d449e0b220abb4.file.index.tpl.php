<?php /* Smarty version Smarty-3.1.18, created on 2023-01-12 15:03:15
...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '9789791756343ae1cecaf76-39358637',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.18',
  'unifunc' => 'content_6343ae1cf3a609_85648457',
  'variables' => 
  array (
    'config' => 0,
    'meta_title' => 0,
...
<?php if ($_valid && !is_callable('content_6343ae1cf3a609_85648457')) {function content_6343ae1cf3a609_85648457($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
...
">
 ...
 <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['time'][0][0]->time_modifier($_smarty_tpl->tpl_vars['pn']->value->created);?>
                ...
                <ul class="navbar-nav my-lg-0">
                    ...
                    <?php if ($_smarty_tpl->tpl_vars['current_offline_point']->value) {?>
                    <li class="nav-item p-2">
                        <?php if (!$_smarty_tpl->tpl_vars['current_offline_point']->value->worktime->open_time) {?>
                            <button class="btn btn-lg btn-info js-open-offline-point" data-point="<?php echo $_smarty_tpl->tpl_vars['current_offline_point']->value->id;?>
" data-name="<?php echo $_smarty_tpl->tpl_vars['current_offline_point']->value->address;?>
">Открыть отделение</button>
                        <?php } elseif (!$_smarty_tpl->tpl_vars['current_offline_point']->value->worktime->close_time) {?>
                            <button class="btn btn-lg btn-info js-close-offline-point" data-point="<?php echo $_smarty_tpl->tpl_vars['current_offline_point']->value->id;?>
" data-name="<?php echo $_smarty_tpl->tpl_vars['current_offline_point']->value->address;?>
">Закрыть отделение</button>
                        <?php }?>
                    </li>
                    <?php }?>
            ...
            <nav class="sidebar-nav">
                <ul id="sidebarnav">
                    ...
                    <?php if (in_array('managers',$_smarty_tpl->tpl_vars['manager']->value->permissions)||in_array('changelogs',$_smarty_tpl->tpl_vars['manager']->value->permissions)||in_array('settings',$_smarty_tpl->tpl_vars['manager']->value->permissions)||in_array('handbooks',$_smarty_tpl->tpl_vars['manager']->value->permissions)||in_array('pages',$_smarty_tpl->tpl_vars['manager']->value->permissions)) {?>
                        ...
                        <?php }?>
                        <?php if (in_array($_smarty_tpl->tpl_vars['manager']->value->role,array('developer','admin','user','big_user'))) {?>
                            <li <?php if (in_array($_smarty_tpl->tpl_vars['module']->value,array('DeleteUsersController'))) {?>class="active"<?php }?>>
                            ...
                            <li <?php if (in_array($_smarty_tpl->tpl_vars['module']->value,array('SettingsController','OfflinePointsController','ScoringsController','ApikeysController','WhitelistController','BlacklistController','PenaltyTypesController'))) {?>class="active"<?php }?>>
                                ...
                                <ul aria-expanded="false" class="collapse">
                                    <?php if (in_array('settings',$_smarty_tpl->tpl_vars['manager']->value->permissions)) {?>
                                        ...
                                        <li <?php if (in_array($_smarty_tpl->tpl_vars['module']->value,array('CallbotController'))) {?>class="active"<?php }?>>
...
<script src="theme/<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['settings']->value->theme, ENT_QUOTES, 'UTF-8', true);?>
/js/apps/worktime.app.js?v=1.00"></script>
