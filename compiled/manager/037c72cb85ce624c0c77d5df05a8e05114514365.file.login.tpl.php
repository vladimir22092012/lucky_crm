<?php /* Smarty version Smarty-3.1.18, created on 2022-10-12 08:32:33
         compiled from "/home/e/ecofinance/lucky_crm/public_html/theme/manager/html/login.tpl" */ ?>
<?php /*%%SmartyHeaderCode:208542646262f62a029f11a4-56285294%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '037c72cb85ce624c0c77d5df05a8e05114514365' => 
    array (
      0 => '/home/e/ecofinance/lucky_crm/public_html/theme/manager/html/login.tpl',
      1 => 1665552752,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '208542646262f62a029f11a4-56285294',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.18',
  'unifunc' => 'content_62f62a02a39058_95884922',
  'variables' => 
  array (
    'config' => 0,
    'settings' => 0,
...
<?php if ($_valid && !is_callable('content_62f62a02a39058_95884922')) {function content_62f62a02a39058_95884922($_smarty_tpl) {?><?php $_smarty_tpl->tpl_vars['wrapper'] = new Smarty_variable('', null, 1);
...
/assets/images/logo_lucky.png" alt="homepage" class="dark-logo" width="300"/>
                    </div>
...
" data-city="<?php echo $_smarty_tpl->tpl_vars['point']->value->city;?>
...
/js/custom.min.js"></script>
    ...
    <script>
        $(function(){
            var display_points = function(city)
            {
                $('[name="offline_point_id"] option').each(function(){
                ...
                if (!$('[name="offline_point_id"] option:selected').is(':visible'))
                {
                    $('[name="offline_point_id"] option[value=""]').attr('selected', true);
                }
            }
            $('[name=cities]').change(function(){
                display_points($(this).val())
            });
            display_points($('[name=cities]').val())
        });
    </script>
