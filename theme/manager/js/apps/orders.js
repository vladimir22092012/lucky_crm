...
*/
    ...
    var _init_daterange = function(){
        ...
        $('.js-daterange-input').change(function(e){
            app.filter(e)
        })
...
console.log(resp);   
    ...
    var _init_period = function(){
        ...
        $(document).on('change', '.js-subfilter', function(e){
            e.preventDefault();
...
//         });
    ...
    app.filter = function(e){
        ...
        var $filter_row =  $(e.target).closest('.jsgrid-filter-row');

        var filter_status = $('#filter_status').val() || '';
        var filter_client = $('#filter_client').val() || '';
        var filter_period = $('#filter_period').val() || '';
        var daterange = $('.js-daterange-input').val() || '';
        var delay_from = $filter_row.find('[name=delay_from]').val() || '';
        var delay_to = $filter_row.find('[name=delay_to]').val() || '';
        var collector_id = $filter_row.attr('data-collector-id') || '';
...
//            period: filter_period,
        ...
        $.ajax({
            ...
            success: function(resp){
                ...
                $('.js-open-contract.js-collector-id-' + collector_id).trigger('click');
    ...
    app.load = function(_url, loading){
        ...
        $.ajax({
            ...
            success: function(resp){
                ...
                $(resp).find('.js-subfilter').each(function(){
                    var _id = $(this).attr('id');
console.log('resp'+_id, $('#'+_id));
                    $('#'+_id).html($(this).html());
                });
