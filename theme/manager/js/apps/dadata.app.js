;function DadataAddressApp($block)
{
    ...
    var _init = function(){
        ...
        app.$input.onestring = app.$block.find('.js-dadata-onestring');
    ...
    var _init_autocomplete_onestring = function(){
        app.$input.onestring.autocomplete({
            serviceUrl:'ajax/dadata.php?action=onestring',
      		minChars:3,
            noCache: true,
...
//                app.$input.city.focus();
                ...
                app.$input.region.attr('data-kladr', suggestion.data.kladr_id);
                app.kladr.region = suggestion.data.kladr_id;
                app.$input.district.val(!!suggestion.data.area ? suggestion.data.area : '')
                app.$input.district_type.val(!!suggestion.data.area_type ? suggestion.data.area_type : '')
                app.$input.locality.val(!!suggestion.data.settlement ? suggestion.data.settlement : '');
                app.$input.locality_type.val(!!suggestion.data.settlement_type ? suggestion.data.settlement_type : '');                                            
                ...
                app.$input.street.val(!!suggestion.data.street ? suggestion.data.street : '')
                app.$input.street_type.val(!!suggestion.data.street_type ? suggestion.data.street_type : '');
                app.kladr.street = !!suggestion.data.street_kladr_id ? suggestion.data.street_kladr_id : '';
                
                app.$input.house.val(!!suggestion.data.house ? suggestion.data.house : '');
                app.$input.building.val(!!suggestion.data.block ? suggestion.data.block : '');
                app.$input.room.val(!!suggestion.data.flat ? suggestion.data.flat : '');
...
//                app.$input.city.focus();
                ...
                app.$input.onestring.val(suggestion.unrestricted_value)
