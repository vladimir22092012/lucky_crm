                ...
                success: function(resp){
                    ...
                    else
                    {
                        ...
                        if (resp.type == 'offline')
                            $item.find('.js-text-type').html('Оффлайн');
            ...
            $.ajax({
                ...
                success: function(resp){
                    ...
                    else
                    {
                        ...
                        if (resp.type == 'client')
                            new_row += '<div class="js-visible-view js-text-type">Отказ клиента</div>';
                        if (resp.type == 'offline')
                            new_row += '<div class="js-visible-view js-text-type">Оффлайн</div>';                        
                        new_row += '<div class="js-visible-edit" style="display:none">';
                        ...
                        new_row += '<option value="offline" '+(resp.type == "offline" ? 'selected' : '') +'>Оффлайн</option>';
                        new_row += '</select>';
                        new_row += '</div>';
                        new_row += '</td>';
                        new_row += '<td>';
