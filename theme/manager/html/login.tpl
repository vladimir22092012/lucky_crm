            ...
            <div class="card-body">
                ...
                <form class="form-horizontal form-material" id="loginform" method="POST">
                    ...
                    <div class="text-center mt-3" >
                        <img src="theme/{$settings->theme|escape}/assets/images/logo_lucky.png" alt="homepage" class="dark-logo" width="300"/>
                    </div>
                    ...
                    <div class="form-group mt-5">
                        <div class="col-xs-12">
                            ...
                            <select name="offline_point_id" class="form-control">
                                ...
                                <option value="{$point->id}" data-city="{$point->city}">{$point->address}</option>
                                {/foreach}
                            </select>
                        </div>
                    </div>
