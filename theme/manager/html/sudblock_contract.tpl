    ...
    <script>
        $(function () {
            ...
            $('#done_task').on('click', function (e) {
                ...
                let comment = $('.comment_event').val();

                if (comment == '') {
                    Swal.fire({
                        text: 'Не введен комментарий',
                        type: 'error',
                    });
                }
                else {
                    $.ajax({
                        ...
                        success: function (suc) {
                            ...
                            Swal.fire({
                                timer: 5000,
                                title: 'Событие успешно выполнено',
                                type: 'success',
                            });
            ...
            $('#change_task').on('click', function (e) {
                e.preventDefault();

                $('.js-visible-view').hide();
                $('.js-visible-edit').fadeIn();
            ...
            $('#cancel_edit').on('click', function (e) {
                ...
                $('.js-visible-edit').hide();
                $('.js-visible-view').fadeIn();
            });

            $('#success_edit').on('click', function (e) {
                e.preventDefault();

                let event_id = $('.option-selected').val();
                let event_text = $('.option-selected').find('option:selected').text();
                let notification_date = $('.notification-date').val();
                let comment = $('.comment_event').val();
                ...
                if (comment == '') {
                    ...
                    $.ajax({
                        ...
                        success: function (suc) {
                            ...
                            $('.option-view').find('option:selected').text(event_text);
                            $('.notification-date-view').val(notification_date);
                            $('.comment_event').val('');

                            $('.notification-date').val(notification_date);
        ...
        <nav>
            <form method="post" action="">
                ...
                <ul class="mcd-menu">
                    <li>
                        <button type="submit"
                                {if array_key_exists('Mon', $count_today)}{$count_today['Mon']}data-badge="{$count_today['Mon']}"{/if}
                                {if array_key_exists('Mon', $not_closed_notifications)}data-badge="{$not_closed_notifications['Mon']}"{/if}
                                class="btn btn-{if $now_date == 'Mon'}success{else}secondary{/if} badge1">Пн
                        </button>
                    </li>
                    <li>
                        <button type="submit"
                                {if array_key_exists('Tue', $count_today)}{$count_today['Tue']}data-badge="{$count_today['Tue']}"{/if}
                                {if array_key_exists('Tue', $not_closed_notifications)}data-badge="{$not_closed_notifications['Tue']}"{/if}
                                class="btn btn-{if $now_date == 'Tue'}success{else}secondary{/if} badge1">Вт
                        </button>
                    </li>
                    <li>
                        <button type="submit"
                                {if array_key_exists('Wed', $count_today)}{$count_today['Wed']}data-badge="{$count_today['Wed']}"{/if}
                                {if array_key_exists('Wed', $not_closed_notifications)}data-badge="{$not_closed_notifications['Wed']}"{/if}
                                class="btn btn-{if $now_date == 'Wed'}success{else}secondary{/if} badge1">Ср
                        </button>
                    </li>
                    <li>
                        <button type="submit"
                                {if array_key_exists('Thu', $count_today)}{$count_today['Thu']}data-badge="{$count_today['Thu']}"{/if}
                                {if array_key_exists('Thu', $not_closed_notifications)}data-badge="{$not_closed_notifications['Thu']}"{/if}
                                class="btn btn-{if $now_date == 'Thu'}success{else}secondary{/if} badge1">Чт
                        </button>
                    </li>
                    <li>
                        <button type="submit"
                                {if array_key_exists('Fri', $count_today)}{$count_today['Fri']}data-badge="{$count_today['Fri']}"{/if}
                                {if array_key_exists('Fri', $not_closed_notifications)}data-badge="{$not_closed_notifications['Fri']}"{/if}
                                class="btn btn-{if $now_date == 'Fri'}success{else}secondary{/if} badge1">Пт
                        </button>
                    </li>
                    <li>
                        <button type="submit"
                                {if array_key_exists('Sat', $count_today)}{$count_today['Sat']}data-badge="{$count_today['Sat']}"{/if}
                                {if array_key_exists('Sat', $not_closed_notifications)}data-badge="{$not_closed_notifications['Sat']}"{/if}
                                class="btn btn-{if $now_date == 'Sat'}success{else}secondary{/if} badge1">Сб
                        </button>
                    </li>
                    <li>
                        <button type="submit"
                                {if array_key_exists('Sun', $count_today)}{$count_today['Sun']}data-badge="{$count_today['Sun']}"{/if}
                                {if array_key_exists('Sun', $not_closed_notifications)}data-badge="{$not_closed_notifications['Sun']}"{/if}
                                class="btn btn-{if $now_date == 'Sun'}success{else}secondary{/if} badge1">Вс
                        </button>
                    </li>
                </ul>
            </form>
    ...
    <div class="container-fluid">
        <div class="row page-titles">
            <div class="col-md-6 col-8 align-self-center">
                <h3 class="text-themecolor mb-0 mt-0"><i class="mdi mdi-animation"></i> Договор №{$contract->number}
                </h3>
                <ol class="breadcrumb">
                                ...
                                <div class="col-12 col-md-6 col-lg-2">
                                    <div class="custom-control custom-checkbox mr-sm-2 mb-3">
                                        <input type="checkbox" class="custom-control-input js-workout-label"
                                               ...
                                               {if $contract->workout}checked{/if} />
                                ...
                                <div class="col-12 col-md-6 col-lg-3 ">
                                    <h5 class="js-order-manager text-right">
                                        {if in_array('change_sudblock_manager', $manager->permissions)}
                                            <select name="manager_id" data-contract="{$contract->id}"
                                                    class="form-control js-manager-select">
                                                <option value="">Не выбран</option>
                                                {foreach $managers as $m}
                                                    {if ($manager->role == 'cheif_exactor' && $m->role=='exactor') || ($manager->role == 'cheif_sudblock' && $m->role=='sudblock')}
                                                        <option value="{$m->id}"
                                                                {if $m->id == $contract->manager_id}selected{/if}>{$m->name|escape}</option>
                            ...
                            <div class="row pt-2">
                                ...
                                <div class="col-12 col-md-8 col-lg-6">
                                    <form action="{url}" class="mb-3 p-2 border js-order-item-form" id="amount_form">
                                        ...
                                        <div class="row view-block ">
                                            ...
                                            <div class="col-2 text-center">
                                                <h6>Проценты</h6>
                                                <h5 class="text-primary">{$contract->contract->loan_percents_summ*1}
                                                    P</h5>
                                            </div>
                                            <div class="col-4 text-center">
                                            ...
                                            <div class="col-2 text-center">
                                                <h6>ОСД</h6>
                                                <h5 class="text-primary">{$contract->contract->loan_body_summ + $contract->contract->loan_percents_summ + $contract->contract->loan_charge_summ + $contract->contract->loan_peni_summ}
                                                    P</h5>
                                            </div>
                                        </div>
                                    </form>
                                ...
                                <div class="col-12 col-md-6 col-lg-3">
                                    ...
                                    <div class="js-order-status">
                                        ...
                                        <h5 class="js-order-manager text-right">
                                            <select name="status" data-contract="{$contract->id}"
                                                    class="form-control js-status-select">
                                                <option value="">Не выбран</option>
                                                {foreach $statuses as $s}
                                                    <option value="{$s->id}"
                                                            {if $s->id == $contract->status}selected{/if}>{$s->name|escape}</option>
                                                {/foreach}
                                            </select>
                                        </h5>
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-9">
                                <ul class="mt-2 nav nav-tabs" role="tablist" id="order_tabs">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link active" data-toggle="tab" href="#documents" role="tab"
                                           aria-selected="true">
                                    ...
                                    <div class="tab-pane p-3 active" id="documents" role="tabpanel">
                                        ...
                                        <div class="card border js-block-documents">
                                            <div class=" card-header text-white">
                                                <h3 class="float-left text-white mb-0">1. Документы для отправки в
                                                    суд</h3>
                                                <div class="float-right">
                                                    {if !$contract->sud_docs_added || $is_developer}
                                                        <a href="{url action='create' block='sud'}"
                                                           class="btn btn-sm btn-warning js-check-manager">
                                                            <span class="btn-label"><i class="fas fa-indent"></i></span>Сформировать
                                                            документы
                                                        </a>
                                                    {/if}
                                                    <a href="javascript.void(0)"
                                                       class="btn btn-sm btn-success js-open-add-document"
                                                       data-type="sud" data-contract="{$contract->id}">
                                                        <span class="btn-label"><i
                                                                    class="fas fa-plus-circle"></i></span>Добавить
                                                        документ
                                                    </a>
                                                </div>
                                            </div>
                                            ...
                                            <table class="table js-sud-documents">
                                                {foreach $sud_documents as $document}
                                                    <tr class="js-document-row">
                                                        <td>
                                                            <div class="custom-control custom-checkbox mr-sm-2 mb-3">
                                                                <input name="doc[]" type="checkbox"
                                                                       class="custom-control-input js-document-check"
                                                                       id="doc_{$document->id}" value="{$document->id}"
                                                                       data-href="{$config->root_url}/files/sudblock/{$contract->id}/{$document->filename}"/>
                                                                <label class="custom-control-label"
                                                                       for="doc_{$document->id}"></label>
                                                            </div>
                                                        </td>
                                                        <td class="text-info">
                                                            <a target="_blank"
                                                               href="{$config->root_url}/files/sudblock/{$contract->id}/{$document->filename}">
                                                                <i class="fas fa-file-pdf fa-lg"></i>&nbsp;
                                                                {$document->name|escape}
                                                            </a>
                                                        </td>
                                                        <td class="text-right">
                                                            <button class="btn btn-sm btn-primary js-print-document waves-effect waves-light"
                                                                    data-user="{$document->user_id}"
                                                                    data-document="{$document->id}" type="button">
                                                                <span class="btn-label"><i
                                                                            class="fas fa-print"></i></span>Печать
                                                            </button>
                                                            {if !$contract->sud_post_number}
                                                                <button title="Документ распечатан и прикреплен"
                                                                        class="js-ready-document btn btn-sm {if $document->ready}btn-success js-is-ready{else}btn-outline-secondary{/if} waves-effect waves-light"
                                                                        data-document="{$document->id}"
                                                                        data-ready="{$document->ready}" type="button">
                                                                    <span class="btn-label"><i class="fa fa-check"></i></span>Готов
                                                                </button>
                                                                <button type="button"
                                                                        class="js-remove-document btn btn-danger btn-sm waves-effect waves-light"
                                                                        data-document="{$document->id}">
                                            ...
                                            {if $sud_documents|count>0}
                                                ...
                                                <div class="p-2">
                                                    <div class="row">
                                                        <div class="col-4">
                                                            <button type="button"
                                                                    class=" mb-1 btn btn-sm btn-primary js-print-check-documents waves-effect waves-light">
                                                                <span class="btn-label"><i
                                                                            class="fas fa-print"></i></span>Распечатать
                                                                выделенное
                                                            </button>
                                                            <button type="button"
                                                                    class="mb-1 btn btn-sm btn-primary js-print-all-documents waves-effect waves-light">
                                                                <span class="btn-label"><i
                                                                            class="fas fa-print"></i></span>Распечатать
                                                                все
                                                            </button>
                                                        ...
                                                        <div class="col-4 text-right">
                                                            <button class="btn {if $contract->sud_docs_sent}btn-success{else}btn-outline-success{/if} js-send-sud waves-effect waves-light"
                                                                    type="button">
                                                                {if $contract->sud_docs_sent}
                                                                    <span class="btn-label"><i
                                                                                class="fas fa-envelope"></i></span>
                                                                    Документы отправлены в суд
                                                                {else}
                                                                    <span class="btn-label"><i
                                            ...
                                            {if $contract->sud_docs_sent}
                                                ...
                                                <div class="p-2 js-sudprikaz-block">
                                                    <div class="row">
                                                        <div class="col-md-3">
                                                            <input type="text" class="form-control js-sudprikaz-number"
                                                                   placeholder="Номер судебного приказа"
                                                                   value="{$contract->sudprikaz_number}"/>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <input type="text" class="form-control js-sudprikaz-date"
                                                                   placeholder="Дата судебного приказа"
                                                                   value="{$contract->sudprikaz_date}"/>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <a href="javascript.void(0)"
                                                               class="btn btn-success js-open-add-document"
                                                               data-type="fssp" data-contract="{$contract->id}">
                                                                <span class="btn-label"><i
                                                                            class="fas fa-plus-circle"></i></span>Скан
                                                                суд. приказа
                                                            </a>
                                                        </div>
                                                        <div class="col-md-3 p-0">
                                                            <button type="submit"
                                                                    class="js-sudrikaz-add btn {if $contract->sudprikaz_added_date}btn-success{else}btn-outline-success{/if} waves-effect waves-light">
                                                                <span class="btn-label"><i
                                        ...
                                        {if $contract->sudprikaz_added_date}
                                            <div class="card border js-block-documents">
                                                <div class=" card-header text-white">
                                                    <h3 class="float-left text-white mb-0">2. Документы для отправки в
                                                        ФССП</h3>
                                                    <div class="float-right">
                                                        {if !$contract->fssp_docs_added}
                                                            <a href="{url action='create' block='fssp'}"
                                                               class="btn btn-sm btn-warning  js-check-manager">
                                                                <span class="btn-label"><i
                                                                            class="fas fa-indent"></i></span>Сформировать
                                                                документы
                                                            </a>
                                                        {/if}
                                                        <a href="javascript.void(0)"
                                                            ...
                                                            <td class="text-right">
                                                                ...
                                                                {if !$contract->fssp_post_number}
                                                                    <button title="Документ распечатан и прикреплен"
                                                                            class="js-ready-document btn btn-sm {if $document->ready}btn-success js-is-ready{else}btn-outline-secondary{/if} waves-effect waves-light"
                                                                            data-document="{$document->id}"
                                                                            data-ready="{$document->ready}"
                                                                            type="button">
                                                                        <span class="btn-label"><i
                                                                                    class="fa fa-check"></i></span>Готов
                                                                    </button>
                                                                    <button type="button"
                                                                            class="js-remove-document btn btn-danger btn-sm waves-effect waves-light"
                                                                            data-document="{$document->id}">
                                                                        <span class="btn-label"><i
                                                                                    class="fas fa-trash"></i></span>Удалить
                                                                    </button>
                                                                {/if}
                                                            </td>
                                                        </tr>
                                                ...
                                                {if $fssp_documents|count>0}
                                                    ...
                                                    <div class="p-2">
                                                        <div class="row">
                                                            <div class="col-4">
                                                                <button type="button"
                                                                        class=" mb-1 btn btn-sm btn-primary js-print-check-documents">
                                                                    <span class="btn-label"><i class="fas fa-print"></i></span>Распечатать
                                                                    выделенное
                                                                </button>
                                                                <button type="button"
                                                                        class="btn btn-sm btn-primary js-print-all-documents">
                                                                    <span class="btn-label"><i class="fas fa-print"></i></span>Распечатать
                                                                    все
                                                                </button>
                                                            </div>
                                                            <div class="col-4">
                                                                Номер почтового
                                                                отправления: {$contract->fssp_post_number}
                                                                {*}
                                                            ...
                                                            <div class="col-4 text-right">
                                                                <button class="btn {if $contract->fssp_docs_sent}btn-success{else}btn-outline-success{/if} js-send-fssp"
                                                                        type="button">
                                                                    <i class="fas fa-retry"></i>
                                                                    {if $contract->fssp_docs_sent}
                                                                        <span class="btn-label"><i
                                                                                    class="fas fa-envelope"></i></span>
                                                                        Документы отправлены в ФССП
                                                                    {else}
                                                                        <span class="btn-label"><i
                                                                                    class="far fa-envelope"></i></span>
                                                                        Отправить документы в ФССП
                                                                    {/if}
                                                                </button>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                        ...
                                                        <div class="row pt-2 view-block {if $contactdata_error}hide{/if}">
                                                            ...
                                                            <div class="col-md-12">
                                                                <div class="form-group row m-0">
                                                                    ...
                                                                    <div class="col-md-8">
                                                                        <p class="form-control-static">{$contract->user->passport_serial} {$order->subdivision_code}
                                                                    ...
                                                                    <div class="col-md-8">
                                                                        <ul class="list-unstyled form-control-static pl-0">
                                                                            {if $contract->user->social}
                                                                                <li>
                                                                                    <a target="_blank"
                                                                                       href="{$contract->user->social}">{$contract->user->social}</a>
                                                                                </li>
                                                                            {/if}
                                                                        </ul>
                                                                    </div>
                                                        ...
                                                        <div class="row m-0 pt-2 pb-2 edit-block {if !$contacts_error}hide{/if}">
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="form-group {if in_array('empty_contact_person_name', (array)$contacts_error)}has-danger{/if}">
                                                                    <label class="control-label">ФИО контакного
                                                                        лица</label>
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="form-group {if in_array('empty_contact_person_phone', (array)$contacts_error)}has-danger{/if}">
                                                                    ...
                                                                    <input type="text" class="form-control"
                                                                           ...
                                                                           value="{$order->contact_person_phone}"
                                                                           placeholder="" required="true"/>
                                                                    {if in_array('empty_contact_person_phone', (array)$contacts_error)}
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="form-group {if in_array('empty_contact_person2_name', (array)$contacts_error)}has-danger{/if}">
                                                                    ...
                                                                    <input type="text" class="form-control"
                                                                           ...
                                                                           value="{$order->contact_person2_name}"
                                                                           placeholder="" required="true"/>
                                                                    {if in_array('empty_contact_person2_name', (array)$contacts_error)}
                                                                        <small class="form-control-feedback">Укажите ФИО
                                                                            контакного лица!
                                                    ...
                                                    <form action="{url}" class="border js-order-item-form mb-3"
                                                        ...
                                                        <input type="hidden" name="order_id"
                                                               value="{$contract->contract->order_id}"/>
                                                        ...
                                                        <div class="row m-0 pt-2 view-block {if $work_error}hide{/if}">
                                                                        ...
                                                                        <div class="col-md-8">
                                                                            ...
                                                                            <span class="clearfix">
                                                                                ...
                                                                                <span class="float-right">
                                                                                    ...
                                                                                    <button class="js-mango-call mango-call js-yuk"
                                                                                            data-phone="{$contract->user->workphone}"
                                                                                            title="Выполнить звонок">
                                                                                        <i class="fas fa-mobile-alt"></i>
                                                                                    </button>
                                                                                </span>
                                                            ...
                                                            <div class="col-md-12">
                                                                <div class="form-group  mb-0 row">
                                                                    ...
                                                                    <div class="col-md-8">
                                                                        <p class="form-control-static">
                                                                            {$contract->user->chief_name}
                                                                            , {$contract->user->chief_position}
                                                                            <br/>
                                                                            {$contract->user->chief_phone}
                                                                            <button class="js-mango-call mango-call js-yuk"
                                                                                    data-phone="{$contract->user->chief_phone}"
                                                                                    title="Выполнить звонок">
                                                                                <i class="fas fa-mobile-alt"></i>
                                                                            </button>
                                                                        </p>
                                                            ...
                                                            {if $contract->user->workcomment}
                                                                <div class="col-md-12">
                                                                    <div class="form-group mb-0 row">
                                                                        <label class="control-label col-md-4">Комментарий
                                                                            к работе:</label>
                                                                        <div class="col-md-8">
                                                                            <p class="form-control-static">
                                                        ...
                                                        {foreach $files as $file}
                                                            ...
                                                            <li class="order-image-item ribbon-wrapper rounded-sm border {$item_class}">
                                                                <a class="image-popup-fit-width"
                                                                   ...
                                                                   onclick="window.open('{$config->front_url}/files/users/{$file->name}');">
                                        ...
                                        <div class="row pb-2">
                                            ...
                                            <div class="col-6 text-right">
                                                <button class="btn btn-loading btn-info js-run-connexions"
                                                        data-user="{$contract->user_id}" type="button">
                            ...
                            <div class="col-md-3">
                                {if !empty($undone_notifications)}
                                    {foreach $undone_notifications as $notification}
                                        <div class="card border js-notification-wrapper undone">
                                            <h5 class=" card-header text-white">
                                                <i class="mdi-note-multiple-outline mdi"></i>
                                                <span>Текущее напоминание</span>
                                            </h5>
                                            ...
                                            <div class="form-group mb-1 js-visible-view">
                                                <select name="event_id" id="block" class="form-control option-view"
                                                        disabled>
                                                    {foreach $events as $event}
                                                        {if $event->id == $notification->event_id}
                                                            <option value="{$notification->event_id}">{$event->name}</option>
                                                        {/if}
                                                    {/foreach}
                                                </select>
                                            </div>
                                            <div class="form-group mb-1 js-visible-edit">
                                                <select name="event_id" id="block" class="form-control option-selected">
                                                    {foreach $events as $event}
                                                        {if $event->id == $notification->event_id}
                                                            <option value="{$notification->event_id}">{$event->name}</option>
                                                        {/if}
                                            ...
                                            <div class="form-group mb-1 js-visible-view ">
                                                <div class="input-group">
                                                    <input type="text" name="notification_date"
                                                           class="form-control singledate notification-date-view"
                                                           value="{$notification->notification_date}" disabled>
                                            ...
                                            <div class="form-group mb-1 js-visible-edit ">
                                                <div class="input-group">
                                                    <input type="text" name="notification_date"
                                                           class="form-control singledate notification-date"
                                                           value="{$notification->notification_date}">
                                                    <div class="input-group-append">
                                                        <spa01n class="input-group-text">
                                                            <span class="ti-calendar"></span>
                                                        </spa01n>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="form-group mb-1">
                                            <textarea placeholder="Комментарий" class="form-control comment_event"
                                                      name="comment"
                                                      style="resize:vertical"></textarea>
                                            </div>
                                            <div class="form-action js-visible-view">
                                                <button id="change_task" data-note-id="{$notification->id}"
                                                        class="btn float-left btn-danger waves-effect waves-light">
                                                    Изменить
                                                </button>
                                                <button id="done_task" data-note-id="{$notification->id}"
                                                        class="btn float-right btn-success waves-effect waves-light">
                                                    Выполнить
                                                </button>
                                            </div>
                                            <div class="form-action js-visible-edit ">
                                                <button id="cancel_edit" data-note-id="{$notification->id}"
                                                        class="btn float-left btn-danger waves-effect waves-light">
                                                    Отмена
                                                </button>
                                                <button id="success_edit" data-note-id="{$notification->id}"
                                                        class="btn float-right btn-success waves-effect waves-light">
                                                    Изменить
                                                </button>
                                            </div>
                                    ...
                                    {/foreach}
                                {else}
                                    <div class="card border js-notification-wrapper new_event">
                                        <h5 class=" card-header text-white">
                                            <i class="mdi-note-multiple-outline mdi"></i>
                                        ...
                                        <form method="POST" id="form_add_notification" class="p-2 border">
                                            ...
                                            <div class="form-group mb-1 js-calendar">
                                                <div class="input-group">
                                                    <input type="text" name="notification_date"
                                                           class="form-control singledate notification-date"
                                                           value="{$notification->notification_date}">
                                            ...
                                            <div class="form-action">
                                                <button type="submit" id="add_notification_event"
                                                        class="btn float-right btn-success waves-effect waves-light">
                                                    Добавить
                                                </button>
                                            </div>
                                ...
                                <div class="card border">
                                    ...
                                    <form method="POST" id="form_add_comment" class="p-2 border"
                                        ...
                                        <div class="form-action">
                                            <button type="button" class="btn float-left btn-danger waves-effect"
...
<div id="modal_add_document" class="modal fade bd-example-modal-sm" tabindex="-1" role="dialog"
     aria-labelledby="mySmallModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
