        ...
        <div class="row page-titles">
            ...
            <div class="col-md-6 col-4 align-self-center">
                <h1 class="text-right p-1" id="ordertimer">
                    ...
                    <div class="text-primary js-ordertimer text-center float-right" style="width:150px" data-time="{$ordertimer->last_time}"></div>
                    {/if}
                </h1>
            </div>
        </div>
                                    ...
                                    <div class="col-12 col-md-6 col-lg-3">
                                        ...
                                        <div class="js-order-status">
                                            ...
                                            {if $order->status == 5}
                                                ...
                                                {/if}
                                                {if $is_developer}
                                                <button class="btn btn-info btn-block js-open-correct-form " data-event="15" data-user="{$order->user_id}" data-order="{$order->order_id}" data-manager="{$manager->id}">Корректировка</button>
                                                {/if}
                                            {/if}
                                            {if $order->status == 6}
                                                <div class="card card-danger mb-1">
                                            ...
                                            <div class="card border border-danger">
                                                <div class="box text-center">
                                                    ...
                                                    <button class="btn btn-outline-warning js-cancel-contract" data-contract="{$contract->id}" type="button">Отменить заявку</button>
                                                </div>
                                            </div>
                                            {/if}
                                                        ...
                                                        <div class="row m-0 mb-2 mt-2 js-dadata-address">
                                                            ...
                                                            <div class="col-md-12">
                                                                <div class="form-group mb-1 {if in_array('empty_regregion', (array)$addresses_error)}has-danger{/if}">
                                                                    <input type="text" class="form-control js-dadata-onestring" name="" value="{$order->Regaddress_full|escape}" placeholder=""/>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <div class="form-group mb-1 {if in_array('empty_regregion', (array)$addresses_error)}has-danger{/if}">
                                                                    ...
                                                                    <div class="col-8 col-sm-8 pb-2">
                                                                        <span class="mail-desc" title="{$scorings[$scoring_type->name]->string_result}">
                                                                            ...
                                                                            {if $scoring_type->name == 'nbki'}
                                                                                ...
                                                                                <span class="mail-desc" title="{$number_of_active}">
                                                                        ...
                                                                        <span class="time">
                                                                            ...
                                                                            {if $scoring_type->name == 'fssp2'}
                                                                                <a href="/ajax/show_fssp2.php?id={$scorings[$scoring_type->name]->id}&password=Hjkdf8d" target="_blank">Подробнее</a>
                                                                            {/if}
                                                                            ...
                                                                            {/if}
                                                                            {if $scoring_type->name == 'nbki'}
                                                                                <a href="http://{$settings->nbki_ip}/nal-plus-nbki/{$scorings[$scoring_type->name]->id}?api=F1h1Hdf9g_h" target="_blank">Подробнее</a>
                                                                            {/if}
                                                                        </span>
                                                                    </div>
                                        ...
                                        <form action="{url}" class="border js-order-item-form mb-3 js-check-images {if $penalties['images'] && $penalties['images']->status!=3}card-outline-danger{/if}" id="images_form" data-user="{$order->user_id}">
                                            ...
                                            <div class="row p-2 view-block {if $socials_error}hide{/if}">
                                                ...
                                                {foreach $files as $file}
                                                    ...
                                                    {/if}
                                                    <li class="order-image-item ribbon-wrapper rounded-sm border {$item_class} js-image-item" data-status="{$file->status}" id="file_{$file->id}" data-id="{$file->id}" data-status="{$file->status}">
                                                        <a class="js-open-popup-image image-popup-fit-width js-event-add-click" data-event="50" data-manager="{$manager->id}" data-order="{$order->order_id}" data-user="{$order->user_id}" data-fancybox="user_image" href="{$config->front_url}/files/users/{$file->name}">
                                        ...
                                        <table class="table table-hover table-condense">
                                            <tbody>
                                                ...
                                                ">
                                                    ...
                                                    <td><strong>{$operation->loan_body_summ+$operation->loan_percents_summ+$operation->loan_charge_summ+$operation->loan_peni_summ}</strong></td>
                                                </tr>
                                                {/foreach}
                                            </tbody>
                                        </table>
                                ...
                                <div class="tab-pane p-3" id="connexions" role="tabpanel">
                                    <div class="row pb-2">
                                        ...
                                        <div class="col-6 text-right">
                                            <button class="btn btn-loading btn-info js-run-connexions" data-user="{$order->user_id}" type="button">
                                            ...
                                            <tbody>
                                                ...
                                                <tr class="communication-{$communication->order_id}">
                                                    ...
                                                    <td class="text-center">
                                                        ...
                                                        <a href="order/{$communication->order_id}" target="_blank"><small>{$communication->order->order_id}</small></a>
                                                        {/if}
                                                    </td>
                                                    <td >
                ...
                <form method="POST" id="form_correct" action="order/{$order->order_id}">
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-6">
                                <input type="text" class="form-control" name="od" required="" value="{$contract->loan_body_summ}" />
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-6">
                                <input type="text" class="form-control" name="percents" required="" value="{$contract->loan_percents_summ}" />
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-6">
                                <input type="text" class="form-control" name="charge" required="" value="{$contract->loan_charge_summ}" />
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-6">
                                <input type="text" class="form-control" name="peni" required="" value="{$contract->loan_peni_summ}" />
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
