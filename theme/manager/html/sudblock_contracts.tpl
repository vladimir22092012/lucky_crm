        ...
        <div class="row page-titles">
            <div class="col-md-6 col-8 align-self-center">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item ">Судблок</li>
                                ...
                                <table class="jsgrid-table table table-striped table-hover">
                                    <tr class="jsgrid-header-row">
                                        <th style="width:20px;" class="jsgrid-header-cell">#</th>
                                            {if in_array($manager->role, ['developer', 'admin', 'chief_exactor', 'chief_sudblock', 'chief_collector'])}
                                    ...
                                    {foreach $contracts as $contract}
                                        ...
                                        <tr class="jsgrid-row js-contract-row {if $contract->workout}workout-row{/if}">
                                            ...
                                            <td style="width: 70px;" class="jsgrid-cell">                                                
                                                ...
                                                {/if}
                                                {if $contract->loan_contract->premier}
                                                <span class="label label-warning">Премьер</span>
                                                {elseif $contract->loan_contract->sold}
