    ...
    $(function(){
        ...
        $('#mail_form').submit(function(e){
            ...
            $.ajax({
                ...
                success: function(resp){
                    if ($(resp).find('.js-success-message').length > 0)
                    {
                        Swal.fire({
                            title: 'Рассылка успешно запущена!',
                            text: $(resp).find('.js-success-message').text(),
                            type: 'success',
                        });
                        
                    }
                    else if ($(resp).find('.js-danger-message').length > 0)
                    {
                        Swal.fire({
                            title: 'Ошибка!',
                            text: $(resp).find('.js-danger-message').text(),
                            type: 'error',
                        });
            ...
            <div class="card-body">
                <form method="POST" id="mail_form">
                    <div class="row">
                        ...
                        {if $success}
                        <div class="col-12 js-success-message">
                        ...
                        {if $errors}
                        <div class="col-12">
                            <div class="alert alert-danger js-danger-message">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="border mt-3">
                                <h5 class="card-header"><span class=""></span></h5>
                                <div class="p-2">
                                    Для добавления в текст рассылки короткой ссылки - добавьте &#123;short_link&#125;
                                    <br>
                                    Например:
                                    <br>
                                    <p><kbd>Срочно погасите просроченную задолженность! Вся информация в личном кабинете: &#123;short_link&#125</kbd></p>
                                </div>
                            </div>
