        ...
        <nav class="navbar top-navbar navbar-expand-md navbar-light">
            ...
            <div class="navbar-header">
                <a class="navbar-brand" href="/">
                    <span>
                     <img src="theme/{$settings->theme|escape}/assets/images/text_logo.png" alt="homepage" class="dark-logo" />
                    </span> 
                    <b>
            ...
            <div class="navbar-collapse">
                                    ...
                                    {if $missings_notifications}
                                        ...
                                        <li>
                                            <div class="message-center">
                                                <!-- Message -->
                                                {foreach $missings_notifications as $mn}
                                                    <a class="message-item">
                                                        <button type="button"
                                                                class="btn btn-info btn-circle btn-lg js-close-missing"
                                                                data-user="{$mn->id}"><i class="fa fa-check"></i>
                                                        </button>
                                                        <div class="mail-contnet" onclick="location.href='missings'">
                                                            <h6>{$mn->phone_mobile|escape} {$mn->lastname|escape} {$mn->firstname|escape} {$mn->patronymic|escape}</h6>
                                                            <span class="time">Посл действие: {$mn->last_stage_date|date} {$mn->last_stage_date|time}</span>
                                                        </div>
                                                    </a>
                                                {/foreach}
                                                <!-- Message -->
                                                ...
                                                {foreach $active_notifications as $an}
                                                    <a href="sudblock_notifications">
                                                        ...
                                                        <div class="mail-contnet">
                                                            ...
                                                            <span class="time">{$an->notification_date|date} {$an->notification_date|time}</span>
                                                        </div>
                                                    </a>
                                                {/foreach}
                                                <!-- Message -->
                ...
                <ul class="navbar-nav my-lg-0">
                    ...
                    <li class="nav-item p-2">
                        {if !$current_offline_point->worktime->open_time}
                            <button class="btn btn-lg btn-info js-open-offline-point" data-point="{$current_offline_point->id}" data-name="{$current_offline_point->address}">Открыть отделение</button>
                        {elseif !$current_offline_point->worktime->close_time}
                            <button class="btn btn-lg btn-info js-close-offline-point" data-point="{$current_offline_point->id}" data-name="{$current_offline_point->address}">Закрыть отделение</button>
                        {/if}
                    </li>
                    {/if}
        ...
        <div class="scroll-sidebar">
            ...
            <nav class="sidebar-nav">
                <ul id="sidebarnav">
                    ...
                    || in_array('clients', $manager->permissions)
                    || in_array('offline', $manager->permissions)
                    || in_array('penalties', $manager->permissions)
                    || in_array ('missings', $manager->permissions)}
                            ...
                            <li {if in_array($module, ['SettingsController', 'OfflinePointsController', 'ScoringsController', 'ApikeysController', 'WhitelistController', 'BlacklistController', 'PenaltyTypesController'])}class="active"{/if}>
                                ...
                                <ul aria-expanded="false" class="collapse">
                                    {if in_array('settings', $manager->permissions)}
                                        ...
                                        <li {if in_array($module, ['RfmController'])}class="active"{/if}><a
                                                    href="rfm/">РФМ</a></li>
                            ...
                            <li {if in_array($module, ['HandbooksController', 'ReasonsController', 'SmsTemplatesController', 'SettingsCommunicationsController', 'TicketStatusesController', 'TicketReasonsController'])}class="active"{/if}>
                                ...
                                <ul aria-expanded="false" class="collapse">
                                    ...
                                    {if in_array('ticket_handbooks', $manager->permissions)}
                                        ...
                                        <li {if in_array($module, ['TicketReasonsController'])}class="active"{/if}><a
...
<script src="theme/{$settings->theme|escape}/assets/plugins/fancybox3/dist/jquery.fancybox.min.js?v=1.03"></script>
<link rel="stylesheet" href="theme/{$settings->theme|escape}/assets/plugins/fancybox3/dist/jquery.fancybox.css?v=1.03"/>
...
<script src="theme/{$settings->theme|escape}/js/apps/dadata.app.js?v=1.05"></script>
...
<script src="theme/{$settings->theme|escape}/js/apps/worktime.app.js?v=1.00"></script>
