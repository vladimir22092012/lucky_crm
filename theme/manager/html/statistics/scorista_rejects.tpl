                    ...
                    <div class="card-body">
                        ...
                        <table class="table table-hover">
                            ...
                            <tr>
                                ...
                                <td>
                                    {if $order->client_status == 'pk'}<span class="label label-info">ПК</span>{/if}
                                    {if $order->client_status == 'nk'}<span class="label label-success">НК</span>{/if}
                                    {if $order->client_status == 'crm'}<span class="label label-primary">ПК CRM</span>{/if}
                                    {if $order->client_status == 'rep'}<span class="label label-warning">Повтор</span>{/if}
                                </td>
                                ...
                                <td><span class="label label-info">{$order->utm_source}</span></td>
                            </tr>
                            {/foreach}
