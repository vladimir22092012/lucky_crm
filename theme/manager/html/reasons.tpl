...
{capture name='page_scripts'}
    ...
    <script src="theme/{$settings->theme|escape}/js/apps/reasons.js?v=1.01"></script>
                                        ...
                                        <tr class="js-item">
                                            ...
                                            <td>
                                                <div class="js-visible-view js-text-type">
                                                    ...
                                                    {if $reason->type == 'offline'}Оффлайн{/if}
                                                </div>
                                                <div class="js-visible-edit" style="display:none">
                                                    <select name="type" class="form-control form-control-sm">
                                                        ...
                                                        <option value="offline" {if $reason->type == 'offline'}selected{/if}>Оффлайн</option>
                                                    </select>
                                                </div>
                                            </td>
                                            <td>
