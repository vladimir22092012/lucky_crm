                            ...
                            <div class="border">
                                ...
                                <div class="p-2 pt-4">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-5 ">
                                                <label class="control-label">Максимальный срок, дней</label>
                                            </div>
                                            <div class="col-7 ">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-5 ">
                                                <label class="control-label">Срок продления, дней</label>
                                            </div>
                                            <div class="col-7 ">
                                                <input type="text" class="form-control" name="prolongation_period" value="{$loantype->prolongation_period}" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
