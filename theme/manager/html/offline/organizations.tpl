    ...
    <div class="container-fluid">
        ...
        <div class="row page-titles">
            ...
            <div class="col-md-6 col-4 align-self-center">
                <a href="offline_organization" class="btn float-right hidden-sm-down btn-success">
                            ...
                            <div class="dataTables_wrapper container-fluid dt-bootstrap4 no-footer">    
                                <table id="config-table" class="table display table-striped dataTable">
                                    ...
                                    <tbody id="table-body">
                                        ...
                                        <tr class="js-item">
                                            <td>
                                                <a href="offline_organization/{$organization->id}" class="js-text-id">
                                                    {$organization->id}
                                                </a>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <div class="js-visible-view js-text-name">
                                                    <a href="offline_organization/{$organization->id}">
                                            ...
                                            <td class="text-right">
                                                <div class="js-visible-view">
                                                    <a href="offline_organization/{$organization->id}" class="text-info" title="Редактировать"><i class=" fas fa-edit"></i></a>
