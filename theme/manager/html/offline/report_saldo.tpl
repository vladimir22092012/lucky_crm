{$meta_title='Оборотно-сальдовая ведомость' scope=parent}
    ...
    <div class="container-fluid">
        ...
        <div class="row page-titles">
            <div class="col-md-6 col-8 align-self-center">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Оборотно-сальдовая ведомость</li>
                </ol>
            </div>
        </div>
        <!-- ============================================================== -->
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Оборотно-сальдовая ведомость за период {if $date_from}{$date_from|date} - {$date_to|date}{/if}</h4>
                        <form>
                            <div class="row">
