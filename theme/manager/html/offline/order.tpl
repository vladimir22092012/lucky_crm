...
{capture name='page_scripts'}
    ...
    <script type="text/javascript" src="theme/{$settings->theme|escape}/js/apps/offline_order.app.js?v=1.01"></script>
                                    ...
                                    <div class="col-4 col-md-3 col-lg-2">
                                        <h4 class="form-control-static">
                                            ...
                                            {else}
                                                ...
                                                {elseif !empty($order->loan_history) && $order->loan_history|count > 0}
                                    ...
                                    <div class="col-12 col-md-4 col-lg-3">
                                        <div class="mb-3 p-2 border ">
                                            ...
                                            <div class="row view-block ">
                                                <div class="col-6 text-center">
                                                    <h5>Ставка % / день</h5>
                                                    <h3 class="text-primary">{$order->percent}</h3>
                                                </div>
                                                <div class="col-6 text-center">
                                                    <h5>Отв-ть % / день</h5>
                                                    <h3 class="text-primary">{$order->charge}</h3>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            {if $order->status == 5}
                                                ...
                                                <div class="card card-danger mb-1">
                                                    <div class="box text-center">
                                                        ...
                                                        <h6 class="text-center text-white">
                                                            Продление: 
                                                            {if $order->organization->commission > 0}
                                                                {$order->organization->commission + $contract->loan_percents_summ+$contract->loan_charge_summ} руб
                                                            {else}
                                                ...
                                                <button class="btn btn-danger btn-block js-open-makepay-form js-event-add-click" data-event="18" data-user="{$order->user_id}" data-order="{$order->order_id}" data-manager="{$manager->id}">Добавить оплату</button>
                                                ...
                                                <form action="{url}" class="mb-3 border js-order-item-form {if $penalties['services'] && $penalties['services']->status!=3}card-outline-danger{/if}" id="services_form">
                                                    ...
                                                    <div class="row view-block p-2 {if $services_error}hide{/if}">
                                                        <div class="col-md-12">
                                                            ...
                                                            <div class="form-group mb-0 row">
                                                                <label class="control-label col-md-8 col-7">Бот информирование:</label>
                                                                <div class="col-md-4 col-5">
                                                                    <p class="form-control-static text-right">
                                                                        {if $order->bot_inform}
                                                                            <span class="label label-success">Вкл</span>
                                    ...
                                    {if $contract_operations}
                                        <table class="table table-hover ">
                                            <tbody>
                                                ...
                                                <tr class="
                                                    {if in_array($operation->type, ['PAY', 'MAKEPAY'])}table-success{/if} 
                                                    {if in_array($operation->type, ['PERCENTS', 'CHARGE', 'PENI'])}table-danger{/if} 
                                                    {if in_array($operation->type, ['P2P', 'ISSUANCE'])}table-info{/if} 
                                                    {if in_array($operation->type, ['INSURANCE', 'SMS_INFORM', 'BOT_INFORM'])}table-warning{/if}
                                                ">
                                                    <td > 
                                                        {*}                                               
                                                        <div class="button-toggle-wrapper">
                                                    ...
                                                    <td >
                                                        ...
                                                        {if $operation->type == 'ISSUANCE'}Выдача займа{/if}
                                                        ...
                                                        {if $operation->type == 'MAKEPAY'}Добавление оплаты{/if}
                                                        ...
                                                        {if $operation->type == 'SMS_INFORM'}Смс-информирование{/if}
                                                        {if $operation->type == 'BOT_INFORM'}Бот-информирование{/if}
                                                    </td>
                                                    <td >
                        ...
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            <li class="nav-item"> 
                                <a class="nav-link active" id="home-tab" data-toggle="tab" href="#reject_mko" role="tab" aria-controls="home5" aria-expanded="true" aria-selected="true">
                                    <span class="hidden-sm-up"><i class="ti-home"></i></span> 
                                    <span class="hidden-xs-down">Оффлайн</span>
                                </a> 
                            </li>
                        </ul>
...
<div id="modal_makepay" class="modal fade bd-example-modal-sm" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" id="form_makepay" class="js-makepay-form">
                    
                    <input type="hidden" name="contract_id" value="{$contract->id}" />
                    <input type="hidden" name="action" value="makepay" />
                    
                    <div class="alert" style="display:none"></div>
                    
                    {if $current_offline_point}
                    <input type="hidden" name="offline_point_id" value="{$current_offline_point->id}" />
                    {else}
                    <div class="form-group">
                        <label for="close_date" class="control-label">Отделение:</label>
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="form-group">
                                <label for="close_date" class="control-label">Сумма:</label>
                                <input type="text" class="form-control" name="amount" required="" placeholder="" value="" />
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="form-group">
                                <label for="close_date" class="control-label">Email для отправки чека:</label>
                                <input type="text" class="form-control" name="email" placeholder="" value="{$order->email}" />
                            </div>    
                        </div>
                    </div>
                    <div class="form-group">
