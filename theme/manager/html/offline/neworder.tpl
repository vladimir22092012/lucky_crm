            ...
            <div class="col-lg-12">
                <div class="card card-outline-info">
                    <div class="card-header">
                        ...
                        <strong> <small class="text-warning float-right"> {$organizations[$current_offline_point->organization_id]->name} </small> </strong>
                    </div> 
                    <div class="card-body">
                        <form method="POST" id="">
                            {if $current_offline_point}
                            <input type="hidden" name="offline_point_id" value="{$current_offline_point->id}" />
                            <input type="hidden" name="organization_id" value="{$current_offline_point->organization_id}" />
                            {/if}
                            <div class="form-body">
                                ...
                                <div class="row">
                                        ...
                                        <div class="row edit-block ">
                                            <div class="col-md-12">
                                                <div class="form-group row {if in_array('empty_period', (array)$amount_error)}has-danger{/if}">
                                                    ...
                                                    <div class="col-md-8">
                                                        <select name="organization_id" class="form-control" readonly>
                                    ...
                                    <div class="col-md-6">
                                        <div class="row edit-block ">
                                            <div class="col-md-12">
                                                <div class="form-group row {if in_array('empty_period', (array)$amount_error)}has-danger{/if}">
                                                    <label class="control-label col-md-4">Филиал:</label>
                                                    <div class="col-md-8">
                                                        <select name="offline_point_id" class="form-control">
                                                            {foreach $offline_points as $point}
                                                            <option value="{$point->id}" {if $point->id==$order->organization_id}selected{/if}>{$point->address|escape}</option>
                                                            {/foreach}
                                                        </select>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row edit-block m-0 mb-2 mt-2 ">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group {if in_array('empty_passport_issued', (array)$passport_error)}has-danger{/if}">
                                                        ...
                                                        <textarea class="form-control js-passport-issued-input" name="passport_issued" required="">{$order->passport_issued}</textarea>
                                    ...
                                    <div class="col-md-6 mb-2">
                                        <div class="border">
                                            ...
                                            <div class="row m-0 pt-2 edit-block js-dadata-work">
                                                {if $work_error}
                                                <div class="col-md-12">
                                                    <ul class="alert alert-danger">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group mb-0 {if in_array('empty_workplace', (array)$work_error)}has-danger{/if}">
                                                        ...
                                                        <input type="text" class="form-control js-workplace-input js-dadata-company" name="workplace" value="{$order->workplace|escape}" placeholder="" required="true" />
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group mb-0">
                                                        ...
                                                        <input type="text" class="form-control js-workaddress-input js-dadata-company-address" name="workaddress" value="{$order->workaddress|escape}" placeholder="" required="true" />
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group mb-0 {if in_array('empty_workphone', (array)$work_error)}has-danger{/if}">
                                                        ...
                                                        <input type="text" class="form-control js-workphone-input js-mask-input js-dadata-phone" name="workphone" value="{$order->workphone|escape}" data-mask="7(999)999-99-99" required="true" />
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group mb-0 {if in_array('empty_chief_name', (array)$work_error)}has-danger{/if}">
                                                        ...
                                                        <input type="text" class="form-control js-chief-name-input js-dadata-chief-name" name="chief_name" value="{$order->chief_name|escape}" placeholder="" required="true" />
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group mb-0 {if in_array('empty_chief_position', (array)$work_error)}has-danger{/if}">
                                                        ...
                                                        <input type="text" class="form-control js-chief-position-input js-dadata-chief-position" name="chief_position" value="{$order->chief_position|escape}" placeholder="" required="true" />
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group mb-0 {if in_array('empty_chief_phone', (array)$work_error)}has-danger{/if}">
                                                        ...
                                                        <input type="text" class="form-control js-chief-phone-input js-mask-input js-dadata-chief-phone" name="chief_phone" value="{$order->chief_phone|escape}" data-mask="7(999)999-99-99" />
