                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group mb-3">
                                ...
                                <div class="">
                                    <input type="text" class="form-control" name="min_threshold_age" value="{$settings->min_threshold_age}" placeholder="">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group mb-3">
                                ...
                                <div class="">
                                    <input type="text" class="form-control" name="max_threshold_age" value="{$settings->max_threshold_age}" placeholder="">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
