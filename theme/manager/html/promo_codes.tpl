...
{capture name='page_scripts'}
    ...
    <script src="theme/manager/js/apps/promo_codes.app.js"></script>
                                        ...
                                        <tr class="js-item">
                                            ...
                                            <td>
                                                <div class="js-visible-view js-text-name">
                                                    {$promo_code->code|escape}
                                                </div>
                                                <div class="js-visible-edit" style="display:none">
                                                    <input type="hidden" name="id" value="{$promo_code->id}" />
                                                    <input type="text" class="form-control form-control-sm" name="code" value="{$promo_code->code|escape}" />
                                                </div>
                                            </td>
                                            <td>
                                                <div class="js-visible-view js-text-template">
                                                    {$promo_code->percent|escape}
                                                </div>
                                                <div class="js-visible-edit" style="display:none">
                                                    <input type="text" class="form-control form-control-sm" name="percent" value="{$promo_code->percent|escape}" />
                                                </div>
                                            </td>
                                            <td class="text-right">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" id="form_add_item">
                    ...
                    <div class="form-group">
                        <label for="percent" class="control-label">Сообщение:</label>
