...
{capture name='page_scripts'}
    ...
    <script>
        ...
        $('.js-communication-filter').click(function(e){
            e.preventDefault();
            ...
            {
                $this.removeClass('btn-primary').addClass('btn-outline-primary').removeClass('selected');
                $('.js-communication-row').show();                
            }
            else
            {
                $('.js-communication-filter.selected').removeClass('selected').removeClass('btn-primary').addClass('btn-outline-primary');
                $this.removeClass('btn-outline-primary').addClass('btn-primary').addClass('selected');                
                $('.js-communication-row').hide();
                $('.js-communication-row-'+_target).show();
            }
        })
    </script>

    <script type="text/javascript" src="theme/{$settings->theme|escape}/js/apps/collector_contract.app.js?v=1.03"></script>
    <script type="text/javascript" src="theme/{$settings->theme|escape}/js/apps/connexions.app.js?v=1.02"></script>
                    ...
                    <div class="card-body">
                            ...
                            <div class="form-body">
                                <div class="row">
                                    ...
                                    <div class="col-12 col-md-6 col-lg-2">
                                        {if in_array($manager->role, ['chief_collector', 'yurist'])}
                                            <div class="custom-control custom-checkbox mr-sm-2 mb-3">
                                                {if $contract->sud}
                                                <span class="label label-danger">Договор передан в суд</span>
                                                {else}
                                ...
                                <div class="row pt-2">
                                    <div class="col-12 col-md-4 col-lg-3">
                                        <form action="{url}" class="js-order-item-form" id="fio_form">
                                            ...
                                            <div class="border p-2 view-block">
                                                ...
                                                {if $manager->role == 'yurist'}
                                                    {if $contract->sold}
                                                    <h4 class="text-warning d-block clearfix"><strong class="float-left">ЮК:</strong> <span class="float-right">{$contract->sold_date|date}</span></h4>
                                                    {/if}
                                                    {if $contract->premier}
                                                    <h4 class="text-danger d-block clearfix"><strong class="float-left">Премьер:</strong> <span class="float-right">{$contract->premier_date|date}</span>
                                                    </h4>
                                                    {/if}
                                                {else}
                                    ...
                                    <div class="col-12 col-md-6 col-lg-3">
                                        ...
                                        <div class="js-order-status">
                                            ...
                                            {if in_array($manager->id, ['2', '1', '61', '27']) || in_array($manager->role, ['chief_collector', 'team_collector'])}
                                                {if $contract->premier}
                                                    <br>
                                                    ...
                                                    <div style="padding-top: 10px;padding-bottom: 10px;">
                                                        ...
                                                        <br>
                                                        <input type="text" id="short_link" name="short_link" value="premier.{$short_link}" size="21">
                                                ...
                                                {elseif $contract->sold}
                                                    ...
                                                    <div style="padding-top: 10px;padding-bottom: 10px;">
                                                        <label id="result" class="title text-white">Короткая ссылка на оплату</label>
                                                        <br>
                                                        <input type="text" id="short_link" name="short_link" value="yk1.{$short_link}" size="21">
                                                        <input type="text" id="phone_short_link" name="phone_short_link" value="{$order->phone_mobile}" size="9">
                                                        <input type="submit" id="submit_short_link" name="submit_short_link" value="Отправить смс">
                                                        <br>
                                                    </div>
                            ...
                            <div class="tab-content tabcontent-border" id="order_tabs_content">
                                            ...
                                            <div class="col-md-4 ">
                                                ...
                                                <div class="mb-2">
                                                    <form action="order/{$order->order_id}">
                                                        ...
                                                        <select class="form-control js-contact-status" data-user="{$order->user_id}" data-contract="{$contract->id}" data-manager="{$manager->id}" data-order="{$order->order_id}" name="contact_status">
                                ...
                                <div class="tab-pane p-3" id="communications" role="tabpanel">
                                    ...
                                    <div class="clearfix">
                                        <h3 class="float-left">Коммуникации с клиентом</h3>
                                        <div class="float-right">
                                            {foreach $communication_contracts as $communication_contract}
                                            <a class="btn btn-xs btn-outline-primary js-communication-filter" data-target="{$communication_contract->id}">{$communication_contract->number}</a>
                                            {/foreach}
                                        </div>
                                    </div>
                                    ...
                                    {if $communications}
                                        <table class="table table-hover table-bordered">
                                            <tbody>
                                                ...
                                                <tr class="js-communication-row js-communication-row-{$communication->contract->id}">
                                                    <td > 
                                                    ...
                                                    <td>
                                                        <a href="collector_contract/{$communication->contract->id}" target="_blank"><small>{$communication->contract->number}</small></a>
                                                    </td>
                                                    <td >
