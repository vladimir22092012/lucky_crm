                    ...
                    <div class="card-body">
                        <div class="clearfix">
                            ...
                            <div class="float-right js-filter-status">
                                <a href="{url status=2}"
                                   class="btn btn-xs {if $filter_status==2}btn-info{else}btn-outline-info{/if}">0-2
                                    дни</a>
                                <a href="{url status=3}"
                                   class="btn btn-xs {if $filter_status==3}btn-secondary{else}btn-outline-secondary{/if}">Ожидание-1</a>
                                <a href="{url status=4}"
                                   class="btn btn-xs {if $filter_status==4}btn-primary{else}btn-outline-primary{/if}">Предсофт</a>
                                <a href="{url status=5}"
                                   class="btn btn-xs {if $filter_status==5}btn-secondary{else}btn-outline-secondary{/if}">Ожидание-2</a>
                                <a href="{url status=6}"
                                   class="btn btn-xs {if $filter_status==6}btn-warning{else}btn-outline-warning{/if}">Софт</a>
                                <a href="{url status=7}"
                                   class="btn btn-xs {if $filter_status==7}btn-secondary{else}btn-outline-secondary{/if}">Ожидание-3</a>
                                <a href="{url status=8}"
                                   class="btn btn-xs {if $filter_status==8}btn-danger{else}btn-outline-danger{/if}">Хард</a>
                                <a href="{url status=9}"
                                   class="btn btn-xs {if $filter_status==9}btn-secondary{else}btn-outline-secondary{/if}">Ожидание-4</a>
                                <a href="{url status=10}"
                                   class="btn btn-xs {if $filter_status==10}btn-danger{else}btn-outline-danger{/if}">Хард-2</a>
                            </div>
                                            ...
                                            <tr class="jsgrid-row js-contract-row">
                                                <td style="width: 120px;" class="jsgrid-cell jsgrid-align-right">
                                                    <div class="button-toggle-wrapper">
                                                        <button class="js-open-contract button-toggle js-collector-id-{$collector->id}"
                                            ...
                                            <tr class="jsgrid-row {if $manager->role!='collector'}js-open-show{/if} js-dopinfo-{$collector->id}">
                                                <td style="width: 120px" rowspan="{($collector->items|count)+1}"
                                                    ...
                                                    <ul class="list-unstyled">
                                                        ...
                                                        <li>
                                                            <h5>Количество закрытых: <strong class="text-primary">{$collector->closed|round}</strong></h5>
                                                        </li>
                                                        <li>
                                                            <h5>Количество пролонгаций: <strong class="text-primary">{$collector->prolongation|round}</strong></h5>
                                                        </li>
                                                    </ul>
                                                </td>
                                                ...
                                                <td style="width: 70px;" class="jsgrid-cell bg-info text-white">
                                                    <div class="row no-gutter jsgrid-filter-row" data-collector-id="{$collector->id}">
                                                        <div class="col-6 pr-0">
                                                            <strong>День просрочки</strong>
                                                        </div>
                                                        <div class="col-3 pr-0">
                                                            <input type="text" placeholder="c" name="delay_from" value="{$filter['delay_from']}" class="form-control input-sm">
                                                        </div>
                                                        <div class="col-3 pl-0">
                                                            <input type="text" name="delay_to" placeholder="по" value="{$filter['delay_to']}" class="form-control input-sm">
                                                        </div>
                                                    </div>
                                                </td>
                                                <td style="width: 70px;" class="jsgrid-cell bg-info text-white">
                                            ...
                                            {foreach $collector->items as $item}
                                                <tr class="jsgrid-row {if $manager->role!='collector'}js-open-show{/if} js-dopinfo-{$collector->id}">
                                                    ...
                                                    <td style="width: 70px;" class="jsgrid-cell">
                                                        ...
                                                        {/if}
                                                        {if $item->prolongation}<span class="label label-success">Пролонгация</span>{/if}
                                                    </td>
                                                    <td style="width: 70px;" class="jsgrid-cell">
                                                <span>
                                                    {if is_null($item->delay_period)}-
                                                    {else}{$item->delay_period}{/if}
                                                </span>
                                                    </td>
                                                    <td style="width: 70px;" class="jsgrid-cell">
