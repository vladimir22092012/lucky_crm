...
class GetInfoAjax extends Core
{
    ...
    public function run()
    {
        ...
        switch ($action):
            ...
            case 'offline_user':
                $this->action_offline_user();
            break;
            
            default:
                $this->response['error'] = 'undefined_method';
    ...
    private function action_offline_user()
    {
        $params = array(
        ...
        $this->response['uid'] = $this->soap1c->generate_uid_client($params);

        $this->response['details'] = $this->soap1c->get_offline_client_details($this->response['uid']);
        $this->response['format'] = $this->helpers->format_client_details($this->response['details']);
    }
