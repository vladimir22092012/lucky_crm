...
class Penalties extends Core
{
	...
	public function get_penalties($filter = array())
	{
        ...
        if (!empty($filter['control_manager_id']))
            $control_manager_id_filter = $this->db->placehold("AND control_manager_id IN (?@)", array_map('intval', (array)$filter['control_manager_id']));
