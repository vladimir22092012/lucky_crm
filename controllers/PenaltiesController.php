...
class PenaltiesController extends Controller
{
    public function fetch()
    {
        ...
        if ($control_manager_id = $this->request->get('control_manager_id', 'integer'))
        {
            $filter['control_manager_id'] = $control_manager_id;
            $this->design->assign('control_manager_id', $control_manager_id);
        }
